...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="col-md-12">
      ...
      <center><h4>FORM PENCARIAN DATA PERJANJIAN BEDAH<br><small style="font-size:12px">(Silahkan lakukan pencarian data berdasarkan parameter dibawah ini)</small></h4></center>
      <br>
