...
<div id="data_pribadi">
        ...
        <div class="form-group" >
          ...
          <div class="col-md-4">            
            ...
            <input type="text" name="nama_pasien" id="nama_pasien" class="form-control" style="width:80%;display:inline" value="<?php echo isset($value)?$value->nama_pasien:''?>" >
        ...
        <div class="form-group">
            ...
            <div id="prov" <?php echo isset($value->id_dc_propinsi) ?'':'style="display:none"'; ?>>
              ...
              <div class="col-md-3">
                  <input id="inputProvinsi" style="margin-left:-9px;margin-bottom:3px;" class="form-control" name="provinsi" type="text" placeholder="Masukan keyword minimal 3 karakter" value="<?php echo isset($value)?($value->id_dc_propinsi!=null)?"$value->id_dc_propinsi : $value->provinsi":'':''?>"/>
              ...
              <div class="col-md-3">
                  <input id="inputKota" style="margin-left:-9px" class="form-control" name="kota" type="text" placeholder="Masukan keyword minimal 3 karakter" value="<?php echo isset($value)?($value->id_dc_kota!=null)?"$value->id_dc_kota : $value->kota":'':''?>"/>
