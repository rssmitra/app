          ...
          <div class="col-md-10">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6" style="left:90%">
                  <button type="button" class="btn btn-xs btn-primary" onclick="getMenu('registration/Reg_klinik')"> <i class="fa fa-refresh"></i> Refresh Page </button>
            ...
            <div class="col-md-4" style="margin-bottom:0px; position:fixed; left: 67%; bottom: 0%; z-index: 999999">
              ...
              <div class="col-sm-12 widget-container-col ui-sortable">
                <div class="widget-box widget-color-dark ui-sortable-handle">
                  ...
                  <div class="widget-body" style="display: none; background-color: white; z-index:99999" id="content_antrian_pasien">
                    <!-- #section:custom/scrollbar -->
                    <div class="widget-main padding-4 scrollable ace-scroll" data-size="125" style="position: relative;">
                      <div class="scroll-track scroll-active" style="display: none; height: auto;"><div class="scroll-bar" style="height: 8px; top: 0px;"></div></div><div class="scroll-content" style="max-height: auto;">
                      <div class="content">

                        <div id="pilihan_loket" style="margin-left: 10px">

                          <span style="margin-top:10px">Pilih Loket : </span> 
                          <select name="select_loket" id="select_loket">
                            <option value="#">-Pilih-</option>
                            <?php for($i=1;$i<11;$i++) :?>
                            <option value="<?php echo $i?>"> <?php echo $i?> </option>
                            <?php endfor;?>
                          </select>
                          <span style="margin-top:10px"> Tipe : </span> 
                          <select name="select_tipe" id="select_tipe">
                            <option value="#">-Pilih-</option>
                            <option value="bpjs" >BPJS</option>
                            <option value="umum">Non BPJS</option>
                          </select>
                          <button class="btn btn-xs btn-success" id="btn_submit_loket" onclick="update_antrian()" style="margin-top:-5px;" type="button" title="Pilih Loket"> <i class="fa fa-check"></i> </button>
                          <!-- <button class="btn btn-xs btn-danger" id="btn_ganti_loket" style="margin-top:-5px" type="button" title="Ganti Loket"> <i class="fa fa-refresh"></i>  </button> -->
                        </div>
                        ...
                        <table border="0" width="100%" style="margin-top:-20px !important">
                          ...
                          <tr>
                            ...
                            <td width="55%" align="center" style="background-color:#e6e2e2;">

                              <div width="100%">
                                <b style="font-size:14px">BPJS</b><br>
                              ...
                              <hr>
                              <div width="100%">
                                <b style="font-size:14px">NON BPJS</b><br>
                                <div width="500%" style="float:left;margin-left:5px">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                      ...
                      <a href="#" name="submit" class="btn btn-xs btn-purple" onclick="showModalDaftarPerjanjian(0)">
                        ...
                        <i class="fa fa-edit"></i> Daftarkan Perjanjian
            ...
            <p><b><i class="fa fa-history"></i> RIWAYAT PASIEN </b></p>
              ...
              <div class="tabbable">  
                ...
                <ul class="nav nav-tabs" id="myTab">
                  ...
                  <li>
                    <a data-toggle="tab" data-id="0" data-url="registration/reg_pasien/riwayat_perjanjian" id="tabs_riwayat_booking_online_id" href="#" onclick="getMenuTabs(this.getAttribute('data-url')+'/'+this.getAttribute('data-id'), 'tabs_detail_pasien')" >
                  ...
                  <li>
                    <a data-toggle="tab" data-id="0" data-url="registration/perjanjian_rj/get_by_mr" id="tabs_riwayat_perjanjian_id" href="#" onclick="getMenuTabs(this.getAttribute('data-url')+'/'+this.getAttribute('data-id'), 'tabs_detail_pasien')" >
