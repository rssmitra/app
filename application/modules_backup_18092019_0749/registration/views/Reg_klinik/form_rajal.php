...
<div class="form-group">
    ...
    <div class="col-sm-4" id="dokter_by_klinik">
    ...
    <div class="col-sm-4" id="dokter_dinamis_klinik" style="display:none;">
...
<div class="form-group">
    ...
    <label class="control-label col-sm-2">Sisa Kuota Dokter</label>
