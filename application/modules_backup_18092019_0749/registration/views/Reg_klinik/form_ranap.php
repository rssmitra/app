...
<div class="form-group">
    ...
    <label class="control-label col-sm-2">Obstetri</label>
...
<div class="form-group">
    ...
    <label class="control-label col-sm-2">*Diagnosa Masuk</label>
...
<div class="form-group" style="display:none" id="ri_klas_titipan_form">
    ...
    <label class="control-label col-sm-2">*Hak Kelas Pasien</label>
...
<div class="form-group">
    ...
    <label class="control-label col-sm-2">*Kelas Ruangan</label>
...
<div  class="form-group">
    ...
    <label class="control-label col-sm-2">Kewajiban Uang Muka</label>
...
<div class="form-group">
    <label class="control-label col-sm-2">*Dokter yang merawat</label>
    <div class="col-sm-4">
...
<div class="form-group">
  ...
  <div class="col-md-3">
   ...
   <label class="control-label col-sm-2">Hubungan Keluarga</label>
