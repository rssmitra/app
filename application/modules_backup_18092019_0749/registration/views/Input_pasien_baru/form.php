...
<div id="data_pribadi">
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <input type="text" name="telp_pasien" id="telp_pasien" class="form-control" value="<?php echo isset($value)?($value->tlp_almt_ttp!=0 || $value->tlp_almt_ttp!='' )?$value->tlp_almt_ttp:$value->no_hp:'' ?>" <?php echo ($flag=='read')?'readonly':''?>>
            </div>
