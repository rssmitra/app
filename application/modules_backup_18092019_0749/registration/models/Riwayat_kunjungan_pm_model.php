...
class Riwayat_kunjungan_pm_model extends CI_Model {
	...
	var $select = 'tc_kunjungan.no_kunjungan,tc_kunjungan.no_mr,tc_kunjungan.no_registrasi,mt_karyawan.nama_pegawai as dokter, asal.nama_bagian as asal_bagian, tujuan.nama_bagian as tujuan_bagian, mt_master_pasien.nama_pasien, tc_kunjungan.tgl_masuk, tc_kunjungan.tgl_keluar,status_isihasil,kode_penunjang,pm_tc_penunjang.flag_mcu';
	...
	private function _main_query(){
		...
		if( $_GET ) {
			...
			if( (isset($_GET['keyword']) AND $_GET['keyword']!='')  ){
				...
				// if( ($_GET['bulan'] == 0) AND ($_GET['tahun']== 0) AND ( ($_GET['from_tgl']=='') AND ($_GET['to_tgl']=='') )){
