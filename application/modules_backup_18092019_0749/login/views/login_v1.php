    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <h2>RSSM - SIRS v.1.0</h2>
          <small style="padding-top:-30px !important; font-size: 14px">Sistem Informasi Rumah Sakit Versi 1.0</small>
          ...
          <form id="form-login" class="p-t-15" method="POST" role="form" action="<?php echo base_url().'login/process'?>" autocomplete="off">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                <a href="#" class="text-info small">Need help?<br>Please call EDP RSSM ext <b>181</b> </a>
              </div>
            </div>
            <!-- END Form Control-->
            ...
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-12 no-padding m-t-12">
                <p style="text-align: justify; padding-left: 10px !important">
                  Copyright <?php echo date('Y')?> @ Rumah Sakit Setia Mitra
                </p>
              </div>
            </div>
          </div>
