...
class Billing_model extends CI_Model {
    ...
    public function getHasilLab($params, $kode_penunjang, $flag_mcu){
        ...
        $this->db->select("a.kode_tarif, a.nama_pemeriksaan, REPLACE(a.nama_tindakan, 'BPJS' , '') as nama_tindakan, a.hasil, a.standar_hasil_pria, a.standar_hasil_wanita, a.satuan, a.keterangan, a.detail_item_1, a.detail_item_2,b.referensi,d.urutan");
        $this->db->from($table);
    ...
    public function get_total_tagihan($obj){
        ...
        $total =  (double)$obj->bill_rs_int + (double)$obj->bill_dr1_int + (double)$obj->bill_dr2_int + (double)$obj->lain_lain;
        return $total;
