                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="pull-right no-padding">
                                        <a href="#" class="btn btn-xs btn-white btn-primary" onclick="rollback_kasir(<?php echo $no_registrasi?>)"> <i class="fa fa-undo"></i> Rollback Kasir </a>
                                        <a href="#" class="btn btn-xs btn-white btn-inverse"> <i class="fa fa-print"></i> Cetak Billing Sementara</a>
                                    </div>
                                </div>
