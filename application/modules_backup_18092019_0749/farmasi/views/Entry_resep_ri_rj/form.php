...
<div class="row">
  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_entry_resep" enctype="multipart/form-data" autocomplete="off" action="farmasi/process_entry_resep/process">      
      ...
      <input type="hidden" name="kode_profit" value="2000">
      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
                <span class="help-inline">
                  <input style="width:80px;text-align:center" name="aturan_pakai" id="aturan_pakai" type="text" />
                </span>
            </div>

            <div class="col-md-3" style="margin-left:-6% !important">
              <select name="bentuk_resep" id="bentuk_resep">
            ...
            <div class="col-md-3" style="margin-left:-7% !important">
              <select name="anjuran_pakai" id="anjuran_pakai">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <textarea name="catatan" class="form-control" id="catatan" placeholder="ex : Antibiotik / Harus dihabiskan / Waktu Pakai" style="height:50px !important"></textarea>
            </div>
          </div> 
