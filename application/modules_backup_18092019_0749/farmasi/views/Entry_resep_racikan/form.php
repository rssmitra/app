    ...
    <div style="margin-top:0px">   
      <form class="form-horizontal" method="post" id="form_entry_resep_racikan" enctype="multipart/form-data" autocomplete="off" action="farmasi/entry_resep_racikan/process">      
        ...
        <div class="row">
          ...
          <div class="col-sm-4" id="data_racikan_div">

              <p><b>DATA RACIKAN</b></p>

              <div class="form-group">
                <label class="control-label col-sm-3">Racikan</label>
                <div class="col-md-9">
              ...
              <div class="form-group">
                ...
                <label class="control-label col-sm-3">Jml Satuan</label>
                <div class="col-md-3">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3">Jasa Prod</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="jasa_prod_racikan" id="jasa_prod_racikan" value="2000">  
                </div>
                <label class="control-label col-sm-3">Jasa R</label>
                <div class="col-md-3">
