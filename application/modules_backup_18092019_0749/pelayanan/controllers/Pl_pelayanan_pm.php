...
class Pl_pelayanan_pm extends MX_Controller {
    ...
    public function process_isi_hasil(){
        ...
        {                       
            ...
            for ($i=0; $i <= $_POST['jumlah_hasilpm']; $i++) { 

                $kode_tc_hasilpenunjang = $this->master->get_max_number('pm_tc_hasilpenunjang', 'kode_tc_hasilpenunjang');
                $kode_trans_pelayanan = $_POST['kode_trans_pelayanan'.$i];
                $kode_mt_hasilpm = $_POST['kode_mt_hasilpm'.$i];
                $hasil = $_POST['hasil_pm'.$i];
                $keterangan = $_POST['keterangan_pm'.$i];
                ...
                //print_r($_POST['kode_tc_hasilpenunjang'.$i]);die;
                ...
                if(isset($_POST['kode_tc_hasilpenunjang'.$i]) AND $_POST['kode_tc_hasilpenunjang'.$i]!=0){
                    
                    $this->Pl_pelayanan_pm->update('pm_tc_hasilpenunjang', $dataexc, array('kode_tc_hasilpenunjang' => $_POST['kode_tc_hasilpenunjang'.$i] ) );
