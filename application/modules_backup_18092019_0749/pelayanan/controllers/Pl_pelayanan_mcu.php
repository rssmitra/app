...
class Pl_pelayanan_mcu extends MX_Controller {
    ...
    public function periksa_bagian($id_pl_tc_poli,$kode_tarif, $kode_dokter) { 
        ...
        //echo '<pre>';print_r($kode_tarif);die;
        ...
        if( is_array($_POST['id_mt_mcu_detail']) ){
            ...
            foreach ($_POST['id_mt_mcu_detail'] as $key => $value) {
                ...
                if($data_paket->kode_bagian!='010901'){
                     /*daftar kunjungan */
                    $title = 'Dari MCU';
                    $no_kunjungan_tujuan = $this->daftar_pasien->daftar_kunjungan($title,$no_registrasi,$no_mr,$_POST['dokter'][$key],$data_paket->kode_bagian,'010901',1);
                    ...
                    if($tujuan==1){
                        ...
                        $no_antrian = $this->master->get_no_antrian_poli($data_paket->kode_bagian,$_POST['dokter'][$key]);
                ...
                $dataexec = array(
                    ...
                    'no_kunjungan' => ($data_paket->kode_bagian=='010901')?$no_kunjungan:$no_kunjungan_tujuan,
