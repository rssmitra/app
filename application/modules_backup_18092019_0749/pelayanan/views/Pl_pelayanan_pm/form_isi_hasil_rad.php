              ...
              if($row_list->kode_tarif!=$kode_tarif){
                ...
                echo
                  '<tr>
                    ...
                    <td height="150px" width="35%"><textarea name="hasil_pm'.$i.'" style="height:100% !important;width:100% !important" class="hasil_pm">'.$hasil.'</textarea></td>    
                    <td height="150px" width="25%"><textarea name="keterangan_pm'.$i.'" style="height:100% !important;width:100% !important" class="keterangan_pm">'.$ket.'</textarea></td>           
