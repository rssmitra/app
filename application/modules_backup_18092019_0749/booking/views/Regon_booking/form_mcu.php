<p style="margin-left:-1%"><b><i class="fa fa-edit"></i> PENDAFTARAN PASIEN MCU</b></p>
...
<div class="form-group">
      ...
      <label class="control-label col-sm-2" for="Province">*Paket Tindakan</label>
...
<div class="form-group">
      ...
      <label class="control-label col-sm-2" for="Province">*Dokter MCU</label>
