...
class Po_penerbitan_model extends CI_Model {
	...
	public function get_detail_brg_permintaan($flag, $id){
		...
		$this->db->select('a.*, c.nama_brg, d.jumlah_besar as jumlah_besar_po, d.content as content_po, d.harga_satuan as harga_satuan_po, d.jumlah_harga as jumlah_harga_po, e.no_po, e.tgl_po, c.satuan_besar, CAST(f.harga_beli as INT) as harga_po_terakhir, c.harga_beli as master_harga');
