<script type="text/javascript">
  ...
  function get_detail_brg_po(myid){
    ...
    if(confirm('Are you sure?')){
      ...
      $.ajax({
          url: 'purchasing/penerimaan_brg/Pb_gudang/get_detail_brg_po',
          type: "post",
          data: {ID:myid},
          dataType: "json",
          beforeSend: function() {
          ...
          complete: function(xhr) {     
            ...
            getMenuTabs('purchasing/penerimaan_brg/Pb_gudang/create_po/'+$('#flag_string').val()+'?'+jsonResponse.params+'', 'tabs_form_po');
            achtungHideLoader();
          }
  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="permintaan/Req_riwayat_permintaan_pemb">
      ...
      <div style="margin-top:-25px">
        ...
        <table id="dynamic-table" base-url="purchasing/penerimaan_brg/Pb_gudang/get_data?flag=<?php echo $flag?>" url-detail="purchasing/penerimaan_brg/Pb_gudang/get_detail/<?php echo $flag?>" class="table table-bordered table-hover">
          <thead>
          <tr>  
