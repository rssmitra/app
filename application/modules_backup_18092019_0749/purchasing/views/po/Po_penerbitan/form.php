        ...
        <div class="widget-main no-padding">
          ...
          <form class="form-horizontal" method="post" id="form_permintaan" action="<?php echo site_url('purchasing/permintaan/Req_pembelian/process')?>" enctype="multipart/form-data" >
            ...
            <div class="form-group">
              ...
              <div class="col-md-2">
                <div class="input-group">
                  <input class="form-control date-picker" name="tgl_po" id="tgl_po" type="text" data-date-format="yyyy-mm-dd" value=""/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-3">
                <input name="id" id="id" value="<?php echo KARS?>" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-actions center">
              <a onclick="getMenuTabs('purchasing/po/Po_penerbitan/view_data?flag=<?php echo $flag?>', 'tabs_form_po')" href="#" class="btn btn-sm btn-success">
