...
<div class="row">
  <div class="col-xs-12">
    ...
    <!-- PAGE CONTENT BEGINS -->
      ...
      <table style="font-size:11px; background-color:#428bca;color:white" width="100%">
        <tr>
          <th class="center" width="">No</th>
        ...
        <?php $no=0; foreach($dt_detail_brg as $row_dt) : if($row_dt->status_po == 1) :$no++?>
          <tr>
            ...
            <td><?php echo $row_dt->kode_brg?></td>
            <td><?php echo $row_dt->nama_brg?></td>
            <td class="center"><?php echo $row_dt->jumlah_besar_po?></td>
            <td class="center"><?php echo $row_dt->satuan_besar?></td>
            <td class="center"><?php echo $row_dt->content_po?></td>
            <td align="right"><?php echo number_format((int)$row_dt->harga_satuan_po).',-'?></td>
            <td align="right"><?php echo number_format((int)$row_dt->jumlah_harga_po).',-'?></td>
          </tr>
        <?php endif; endforeach;?>
      </table>
    <!-- PAGE CONTENT ENDS -->
