    ...
    if(confirm('Are you sure?')){
      ...
      $.ajax({
          ...
          complete: function(xhr) {     
            ...
            getMenuTabs('purchasing/po/Po_penerbitan/create_po/'+$('#flag_string').val()+'?'+jsonResponse.params+'', 'tabs_form_po');
            achtungHideLoader();
          }
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="permintaan/Req_riwayat_permintaan_pemb">
      ...
      <center>
          <h4>
            PENERBITAN PO ( GUDANG <?php echo($flag=='non_medis')?'UMUM':'MEDIS'?> )<br><small style="font-size:12px">Data yang ditampilkan saat ini adalah Data Permintaan Pembelian Gudang <?php echo($flag=='non_medis')?'Umum':'Medis'?> Yang sudah disetujui Tahun <?php echo date('Y')?> </small>
          </h4>
      </center>
      ...
      <div style="margin-top:-25px">
        ...
        <table id="dynamic-table" base-url="purchasing/po/Po_penerbitan/get_data?flag=<?php echo $flag?>" url-detail="purchasing/po/Po_penerbitan/get_detail/<?php echo $flag?>" class="table table-bordered table-hover">
          <thead>
          <tr>  
