  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="permintaan/Req_riwayat_permintaan_pemb">
      ...
      <div style="margin-top:-27px">
        ...
        <table id="dynamic-table" base-url="purchasing/permintaan/Req_riwayat_permintaan_pemb/get_data?flag=<?php echo $flag?>" url-detail="purchasing/permintaan/Req_riwayat_permintaan_pemb/get_detail/<?php echo $flag?>" class="table table-bordered table-hover">
          <thead>
          <tr>  
