...
class Lap_hasil_so extends MX_Controller {
    ...
    public function view_data_hasil_so($agenda_so_id, $kode_bagian, $flag)
    {
        $data = array();
        /*define data variabel*/
        $data['title'] = $this->master->get_string_data(array('nama_bagian'),'mt_bagian', array('kode_bagian' => $kode_bagian));
    ...
    public function excel()
    {
        $data = array();
        /*define data variabel*/
        $data['title'] = $this->master->get_string_data(array('nama_bagian'),'mt_bagian', array('kode_bagian' => $_GET['kode_bagian']));
    ...
    public function get_data_hasil_bag_so()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = $row_list->nama_petugas;
            $row[] = '<div class="pull-right">'.$this->tanggal->formatDateTime($row_list->tgl_stok_opname).'</div>';
