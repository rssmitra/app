...
class Input_dt_so extends MX_Controller {
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div class="center"><input type="text" name="stok_kartu" id="row_'.$row_list->kode_brg.'_'.$row_list->kode_brg.'_'.$this->agenda_so_id.'" style="width:80px !important; text-align: center" onkeyup="updateRow('."'".$row_list->kode_brg."'".', '."'".$row_list->kode_bagian."'".','.$this->agenda_so_id.')"></div>';
    ...
    public function set_status_brg()
    {
        ...
        if($_POST['kode_bagian']=='070101'){
            ...
            $this->Input_dt_so->update_status_brg('mt_barang', array('status_aktif' => $_POST['value']), array('kode_brg' => $_POST['kode_brg']) );
