      ...
      <table id="dt-bag-so" base-url="inventory/so/Lap_hasil_so/get_data_bag_so?agenda_so_id=<?php echo $agenda_so_id?>&flag=<?php echo $flag?>" class="table table-bordered table-hover">
       <thead>
        <tr>  
          ...
          <th style="background-color: black" width="100px">Kode Bagian</th>
          <th style="background-color: black">Nama Bagian</th>
          <th style="background-color: black" style="width:30px">Total Barang</th>
