...
$(document).ready(function(){
  ...
  $.getJSON("<?php echo site_url('Templates/References/getDokterByBagian_/013101') ?>", function (data) {              
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="hemodialisa/Hd_riwayat_pasien" class="table table-bordered table-hover">
       <thead>
        <tr>  
