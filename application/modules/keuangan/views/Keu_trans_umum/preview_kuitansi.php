	...
	<div class="row"> 
		<div class="col-xs-8">
			<table style="font-size:12px" border="0">
				<tr> 
					<td width="20%" style="font-size:12px">No Kuitansi </td> 
					<td width="67%"><font size="2">: <?php echo $value->no_bukti; ?>&nbsp;</font></td>
				</tr>
				<tr> 
					<td width="20%" style="font-size:12px">Telah Terima dari </td> 
					<td width="67%"><font size="2">: <?php echo $value->penerima; ?>&nbsp;</font></td>
				</tr>
				<tr>
					<td width="20%" style="font-size:12px">Uang Sejumlah</td> 
					<td width="67%" bgcolor="#EBEBEB" nowrap style="font-size:12px">: <b>Rp. <?php echo number_format($value->jumlah)?></b></td> 
				</tr>
				<tr>
					<td width="20%" valign="top" style="font-size:12px">Terbilang </td> 
					<td style="67%" bgcolor="#EBEBEB" nowrap style="font-size:12px">: 
					<b>
						<i>"<?php $terbilang = new Kuitansi(); echo ucwords($terbilang->terbilang($value->jumlah))?> Rupiah"</i></b>
					</td>
				</tr> 
				<tr>
					<td width="20%">&nbsp;</td> 
				...
				<tr> 
					...
					<td width="67%" bgcolor="#EBEBEB">: <?php echo $value->uraian; ?></td> 
				</tr>
			</table>
			<br>
			<table width="90%" border="0" cellspacing="0" cellpadding="2" align="center"> 
				<tr> 			
					...
					<td valign="top" width="55%" align="center" style="font-size:12px">
						Jakarta, <?php echo $value->tgl_transaksi ?><br>Penerima
						<br/><br/><br/><br/> 
						<br/><BR><BR> 
						( ..................... )<br/><br/>
						</td>
