    ...
    $('#form_kepeg_dt_pegawai').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          // close modal
          $('#widget-body-div').html('<div class="center"><h2><i class="fa fa-check green bigger-250"></i><br><b class="green">Sukses</b></h2>Data kepegawaian anda berhasil diproses<br><br><button type="button" class="btn btn-xs btn-danger" data-dismiss="modal" aria-hidden="true"><span class="black">x Close </span></button></div>', 'UPDATE DATA KEPEGAWAIAN');
