...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="tarif/Mst_tarif/find_data">
      ...
      <center>
          <h4>FORM PENCARIAN DATA PENGAJUAN LEMBUR<br><small style="font-size:12px">Data yang ditampilkan adalah data pengajuan lembur pegawai  </small></h4>
      </center>
      <br>
      ...
      <div class="clearfix" style="margin-bottom:-5px">
        <?php echo $this->authuser->show_button('kepegawaian/Kepeg_persetujuan_lembur','C','',1)?>
          <?php echo $this->authuser->show_button('kepegawaian/Kepeg_persetujuan_lembur','D','',5)?>
      </div>
