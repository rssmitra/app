  ...
  $(document).ready(function(){
    ...
    $('#btn_search_data').click(function (e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#rekap_lembur_pegawai').load('kepegawaian/Kepeg_verifikasi_lembur/show_lembur_pegawai?'+response.data+'');
        }
      });
    });
    ...
    $('#btn_export_excel').click(function (e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            window.open('kepegawaian/Kepeg_verifikasi_lembur/export_excel?export=true&'+response.data+'','_blank'); 
          }
        });
    });
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="kepegawaian/Kepeg_verifikasi_lembur/find_data">
