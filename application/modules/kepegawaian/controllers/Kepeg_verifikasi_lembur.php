...
class Kepeg_verifikasi_lembur extends MX_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        /*breadcrumb default*/
        $this->breadcrumbs->push('Index', 'kepegawaian/Kepeg_verifikasi_lembur');
        /*session redirect login if not login*/
        if($this->session->userdata('logged')!=TRUE){
            echo 'Session Expired !'; exit;
        }
        /*load model*/
        $this->load->model('Kepeg_verifikasi_lembur_model', 'Kepeg_verifikasi_lembur');
        /*enable profiler*/
    ...
    public function index() { 
        ...
        /*load view index*/
        $this->load->view('Kepeg_verifikasi_lembur/index', $data);
    }
    ...
    public function show_lembur_pegawai()
    {
        ...
        $result = $this->Kepeg_verifikasi_lembur->get_rekap_lembur_pegawai($_GET['unit'], $_GET['bulan'], $_GET['tahun']);
        ...
        /*load form view*/
        $this->load->view('Kepeg_verifikasi_lembur/form_rincian_lembur', $data);
    }
    ...
    {
        /*get data from model*/
        $list = $this->Kepeg_verifikasi_lembur->get_datatables();
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div class="center">
                        <a href="#" class="label label-xs label-success" onclick="getMenu('."'kepegawaian/Kepeg_verifikasi_lembur/form_rincian_lembur/".$row_list->pengajuan_lembur_id."'".')"><i class="fa fa-edit"></i> Persetujuan </a>
            </div>';
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Kepeg_verifikasi_lembur->count_all(),
                        "recordsFiltered" => $this->Kepeg_verifikasi_lembur->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        /*get data from model*/
        $list = $this->Kepeg_verifikasi_lembur->get_datatables_rincian_lembur();
    ...
    public function process()
    {
        ...
        {                       
            ...
            $this->Kepeg_verifikasi_lembur->update('kepeg_log_acc_pengajuan', array('log_acc_id' => $id), $dataexc );
            // get detail atasan
            $dt_pegawai = $this->db->get_where('view_dt_pegawai', array('kepeg_id' => $val->set_value('acc_by_kepeg_id') ) )->row();
             if(!empty($dt_pegawai)){
                ...
                // log acc
                $spv = $this->Kepeg_verifikasi_lembur->get_spv($dt_pegawai->kepeg_unit, $acc_level);
                if(!empty($spv)){
                    $dataacc = array(
                    ...
                    $this->Kepeg_verifikasi_lembur->save('kepeg_log_acc_pengajuan', $dataacc);
                }
            }
