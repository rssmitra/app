  ...
  <div class="col-md-12">
    ...
    <div class="center">
        ...
        <div class="col-md-12 no-padding">
            <label class="pull-left">S (<i>Subjective</i>) <span style="color:red">(*)</span></label><br>
        ...
        <div class="col-md-12 no-padding">
            <label class="pull-left">O (<i>Objective</i>) <span style="color:red">(*)</span></label><br>
            <div class="col-sm-12 no-padding">
        ...
        <div class="col-md-12 no-padding">
            <label class="pull-left">A (<i>Assesment</i>) <span style="color:red">(*)</span></label><br>
            <div class="col-sm-12 no-padding">
        ...
        <div class="col-md-12 no-padding">
            <label class="pull-left">P (<i>Plan</i>) <span style="color:red">(*)</span></label><br>
            <div class="col-sm-12 no-padding">
