...
class Adm_tagihan_pelunasan extends MX_Controller {
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div class="center"><a href="#" class="label label-xs label-primary" onclick="getMenuTabs('."'adm_pasien/penagihan/Adm_tagihan_pelunasan/form/".$row_list->id_tc_tagih."'".', '."'load_form_pembayaran'".')">Bayar Tagihan</a></div>';
