  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <form action="#" method="POST" id="form_data_pasien" enctype="multipart/form-data">
        ...
        <table id="dt_search_result_pasien" base-url="adm_pasien/loket_kasir/adm_blm_submit/get_data?flag=<?php echo $flag?>&pelayanan=<?php echo $pelayanan?>" url-detail="billing/Billing/getDetailBillingKasir" class="table table-bordered table-hover">
          <thead>
