...
<script type="text/javascript">
  ...
  function show_detail_inv(kode_tc_trans_kasir, id_tc_tagih){
    ...
    $.getJSON("adm_pasien/pembayaran_hutang/Adm_pembayaran_pengajuan/get_billing_detail/" + kode_tc_trans_kasir, '', function (response) {
        ...
        <div class="control-label col-md-2">
          <div class="checkbox" style="margin-top: -5px">
            <label>
              ...
              <span class="lbl"> No Tanda Terima Faktur</span>
            </label>
          </div>
        </div>
        <div class="col-md-2" style="margin-left: -15px">
