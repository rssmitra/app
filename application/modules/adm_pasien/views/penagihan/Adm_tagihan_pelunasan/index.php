...
<script type="text/javascript">
  ...
  function show_detail_inv(kode_tc_trans_kasir, id_tc_tagih){
    ...
    $.getJSON("adm_pasien/penagihan/Adm_tagihan_pelunasan/get_billing_detail/" + kode_tc_trans_kasir+'?id_tc_tagih='+id_tc_tagih+'', '', function (response) {
      ...
      $('<tr><td align="right" colspan="2">Jumlah dibayarkan pasien</td><td align="right">'+formatMoney(response.invoice.beban_pasien_int)+'</td></tr>').appendTo($('#dt_detail_invoice_'+id_tc_tagih+'')); 
      ...
      var total_tagihan = parseInt(response.total) - parseInt(response.invoice.beban_pasien_int) - parseInt(response.invoice.penyesuaian);
