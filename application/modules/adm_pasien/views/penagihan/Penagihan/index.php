...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    function merge_registrasi( arr ){
      $.ajax({
          url: 'adm_pasien/penagihan/Adm_tagihan_perusahaan/merge_data_registrasi',
          type: "post",
          data: { value : arr },
          dataType: "json",
          beforeSend: function() {
  ...
  function get_total_billing(){
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $.getJSON("adm_pasien/penagihan/Adm_tagihan_perusahaan/get_total_billing?"+response.data, '', function (data) {
             // code here
