...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="adm_pasien/penagihan/Adm_tagihan_list/find_data">
      ...
      Data yang ditampilkan dibawah ini adalah Data Tagihan Bulan <b><?php echo $this->tanggal->getBulan(date('m'))?></b> Tahun <b><?php echo date('Y')?></b> (Default)<br><br>
      </div>
      <div class="pull-right">Total tagihan<br><b><span id="txt_total_tagihan" style="font-size: 18px"></span></b></div>
      <div class="clearfix"></div>
      <br>
      <div style="margin-top:-27px">
        <table id="dt_table_perusahaan" base-url="adm_pasien/penagihan/adm_tagihan_list/get_data?<?php $qry_url = isset($_GET) ? http_build_query($_GET) . "\n" : ''; echo $qry_url?>" url-detail="adm_pasien/penagihan/adm_tagihan_list/get_hist_inv" class="table table-bordered table-hover">
          <thead>
