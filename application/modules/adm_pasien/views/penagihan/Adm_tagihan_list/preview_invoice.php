  ...
  <table id="no-border" style="width: 100% !important;">
    <tr>
      <td width="50%">
        ...
        <span>Tanggal. <?php echo $this->tanggal->formatDatedmY($result[0]->tgl_tagih); ?></span><br>
        Tanggal jatuh tempo pembayaran.<br><?php echo $this->tanggal->formatDatedmY($result[0]->tgl_jt_tempo); ?>
      </td>
