...
$(document).ready(function(){
  ...
  $('#input_keyword').keyup(function(){
      ...
      if(searchedText != ''){
        page = $('table .tbl_nama_pemeriksan td').text();
        $("table .tbl_nama_pemeriksaan td:contains('"+searchedText+"')").css("color", "red");
      }else{
        $(".tbl_nama_pemeriksaan td:contains('')").css("color", "black");
      }
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div>
          ...
          <input type="text" class="form-control" id="input_keyword" placeholder="Masukan keyword">
        </div>
        <br>
          ...
          <table style="font-size: 10px; width: 100%">
            ...
            <tr>
              <td style="vertical-align: top; width: 25%">
                <table class="tbl_nama_pemeriksaan">
                  <?php 
