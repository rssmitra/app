...
<div style="margin-top: 6px">
    ...
    <label for="form-field-8">
        <label><input type="checkbox" class="ace" name="checklist_status_lokaslis" id="checklist_status_lokaslis" <?php echo (isset($riwayat->anatomi_tagging) && !empty($riwayat->anatomi_tagging)) ? 'checked' : ''?> ><span class="lbl"> <b>Status Lokalis</b></span></label>
         <br><span style="font-size: 11px; font-style: italic">(Mohon di<i>tagging</i> status lokalis pada gambar anatomi tubuh pasien)</span>
    </label>
    <!-- status lokalis -->
    <div id="form_status_lokalis" <?php echo (isset($riwayat->anatomi_tagging) && !empty($riwayat->anatomi_tagging)) ? '' : 'style="display: none;"'?>>
