...
<div class="pull-left">
  <p><b><i class="fa fa-edit"></i> INPUT HASIL PEMERIKSAAN <?php echo strtoupper($_GET['title'])?></b></p>
</div>
...
<div class="pull-right" style="padding-bottom: 3px">
  <div class="form-group">
    <div class="col-sm-12 no-padding">
      ...
      <button type="button" class="btn btn-xs btn-danger" id="btn_delete_hasil"> <i class="fa fa-trash"></i> Hapus Hasil Pemeriksaan </button>
    </div>
  </div>
</div>
...
<div class="form-group">
  <div class="col-md-12 no-padding">
    <div class="wysiwyg-editor" id="editor_konten">
...
<div class="form-group">
    <div class="col-sm-12 no-padding">
        <button type="submit" class="btn btn-xs btn-block btn-primary" id="btn_submit_input_hasil"> <i class="fa fa-save"></i> Submit </button>
    </div>
</div>
