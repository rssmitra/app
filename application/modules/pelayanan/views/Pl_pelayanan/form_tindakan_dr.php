...
function getDetailTarifByKodeTarifAndKlas(kode_tarif, kode_klas){
  ...
  preventDefault();
  $.getJSON("<?php echo site_url('templates/references/getDetailTarif') ?>?kode="+kode_tarif+"&klas="+kode_klas+"&type=html&format=formdr", '' , function (data) {
    var obj = data.data[0];
    console.log(obj);
...
<div class="row">
    <div <?php $col_sm = (in_array($sess_kode_bag, array('050201','050101'))) ? 8 : 12; ?>class="col-sm-<?php echo $col_sm?>">
        <p><b> TINDAKAN / PEMERIKSAAN <i class="fa fa-angle-double-right bigger-120"></i></b></p>
        ...
        <div class="col-sm-12 no-padding" id="formDetailTarif" style="display:none;">
