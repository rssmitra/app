...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="pelayanan/Pl_pelayanan_vk/find_data">
    ...
    <div class="col-md-12">
      ...
      <!-- hidden form -->
      <input type="hidden" name="sess_kode_bagian" value="<?php echo $sess_kode_bagian?>" id="sess_kode_bagian">
