...
<input type="hidden" class="form-control" name="kode_meninggal" id="kode_meninggal" value="<?php $is_die = isset($pengkajian_keperawatan['penanganan_meninggal'])?$pengkajian_keperawatan['penanganan_meninggal']:''; echo ($is_die == 'on') ? 1 : 0?>">
...
<div class="form-group">
    ...
    <div class="col-sm-3">
      <?php 
        if(isset($pengkajian_keperawatan['triase_merah']) && $pengkajian_keperawatan['triase_merah'] == 'on'){
            $selected = 1;
        }elseif(isset($pengkajian_keperawatan['triase_kuning']) && $pengkajian_keperawatan['triase_kuning'] == 'on'){
            $selected = 2;
        }elseif(isset($pengkajian_keperawatan['triase_hijau']) && $pengkajian_keperawatan['triase_hijau'] == 'on'){
            $selected = 3;
        }elseif(isset($pengkajian_keperawatan['triase_hitam']) && $pengkajian_keperawatan['triase_hitam'] == 'on'){
            $selected = 4;
        }else{
            $selected = ($riwayat->kategori_tindakan)?$riwayat->kategori_tindakan:'';
        }
...
<div style="margin-top: 6px">
    ...
    <textarea class="form-control" name="pl_anamnesa" style="height: 100px !important" id="pl_anamnesa"><?php echo isset($riwayat->anamnesa)?$this->master->br2nl($riwayat->anamnesa):$this->master->br2nl($pengkajian_keperawatan['subjective_anamnesa'])?></textarea>
...
<div style="margin-top: 6px">
    ...
    <table class="table">
        ...
        <tr style="background: aliceblue;">
            <td>
                <input type="text" style="text-align: center" class="form-control" name="pl_tb_igd" value="<?php echo isset($riwayat->tinggi_badan)?$riwayat->tinggi_badan:''?>">
            </td>
            <td>
                <input type="text" style="text-align: center" class="form-control" name="pl_bb_igd" value="<?php echo isset($riwayat->berat_badan)?$riwayat->berat_badan:$pengkajian_keperawatan['bb_v']?>">
            </td>
            <td>
                <input type="text" style="text-align: center" class="form-control" name="pl_td_igd" value="<?php echo isset($riwayat->tekanan_darah)?$riwayat->tekanan_darah:''?>">
            </td>
            <td>
                <input type="text" style="text-align: center" class="form-control" name="pl_nadi_igd" value="<?php echo isset($riwayat->nadi)?$riwayat->nadi:$pengkajian_keperawatan['nadi']?>">
            </td>
            <td>
                <input type="text" style="text-align: center" class="form-control" name="pl_suhu_igd" value="<?php echo isset($riwayat->suhu)?$riwayat->suhu:$pengkajian_keperawatan['suhu']?>">
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <textarea name="pl_pemeriksaan" id="pl_pemeriksaan" class="form-control" style="height: 100px !important"><?php echo isset($riwayat->pemeriksaan)?$this->master->br2nl($riwayat->pemeriksaan):$this->master->br2nl($pengkajian_keperawatan['objective_pemeriksaan_fisik'])?></textarea>
...
<div style="margin-top: 6px">
    ...
    <input type="text" class="form-control" name="pl_diagnosa" id="pl_diagnosa" placeholder="Masukan keyword ICD 10" value="<?php echo isset($riwayat->diagnosa_akhir)?$riwayat->diagnosa_akhir:$pengkajian_keperawatan['assesmen_diagnosa_primer']?>">
    <input type="hidden" class="form-control" name="pl_diagnosa_hidden" id="pl_diagnosa_hidden" value="<?php echo isset($riwayat->kode_icd_diagnosa)?$riwayat->kode_icd_diagnosa:$pengkajian_keperawatan['assesmen_diagnosa_primer_hidden']?>">
</div>
...
<div style="margin-top: 6px">
    ...
    <div id="pl_diagnosa_sekunder_igd_hidden_txt" style="padding: 2px; line-height: 23px; border: 1px solid #d5d5d5; min-height: 25px; margin-top: 2px">
        <?php
            $arr_text = isset($riwayat->diagnosa_sekunder) ? explode('|',$riwayat->diagnosa_sekunder) : explode('|',$pengkajian_keperawatan['diagnosa_sekunder']);
...
<div style="margin-top: 6px">
    ...
    <textarea name="pl_pengobatan" id="pl_pengobatan" class="form-control" style="height: 100px !important"><?php echo isset($riwayat->pengobatan)?$this->master->br2nl($riwayat->pengobatan):$this->master->br2nl($pengkajian_keperawatan['planning_anjuran_dokter'])?></textarea>
</div>
<div style="margin-top: 6px">
