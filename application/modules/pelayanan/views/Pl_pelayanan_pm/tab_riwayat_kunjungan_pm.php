<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var url = (no_reg!='')?'Pelayanan/Pl_pelayanan_pm/get_data?mr='+no_mr+'&tujuan='+tujuan+'&no_reg='+no_reg+'':'Pelayanan/Pl_pelayanan_pm/get_riwayat_kunjungan_pm?mr='+no_mr+'&kode_bagian='+kode_bagian+'';
