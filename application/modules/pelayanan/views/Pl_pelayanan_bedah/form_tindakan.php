...
$(document).ready(function() {
  ...
  //initiate dataTables plugin
    oTableTindakan = $('#table-tindakan').DataTable({ 
      ...
      "ajax": {
          "url": "pelayanan/Pl_pelayanan/get_data_tindakan?bagian=<?php echo ($sess_kode_bag)?$sess_kode_bag:0?>&jenis=tindakan&kode=<?php echo $no_kunjungan?>",
          "type": "POST"
      },
    ...
    $('#btn_add_tindakan').click(function (e) {   
      ...
      if($('#tindakan_luar').val() != "undefined" && $('#tindakan_luar').val() != 1){
    ...
    $('#btn_add_tindakan_luar').click(function (e) {   
      ...
      /*process add konsultasi*/
      $.ajax({
          url: "templates/references/tindakanLuarRS",
          data: $('#form_pelayanan').serialize(),            
          dataType: "json",
          type: "POST",
          success: function (response) {
