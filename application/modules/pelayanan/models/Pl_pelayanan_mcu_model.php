...
class Pl_pelayanan_mcu_model extends CI_Model {
	...
	private function _main_query(){
		...
		$this->db->join('tc_trans_pelayanan_mcu_v','tc_registrasi.no_registrasi=tc_trans_pelayanan_mcu_v.no_registrasi','left');
 ...
 //        return $exc->result();
	...
	public function get_detail_mcu_bagian( $kode_tarif ){
		$this->db->select('b.nama_bagian, c.nama_tarif as paket_mcu, d.nama_tarif as detail_paket_mcu');
		$this->db->from('mt_mcu_tarif_detail a');
		$this->db->join('mt_bagian b','b.kode_bagian=a.kode_bagian','left');
		$this->db->join('mt_master_tarif c','c.kode_tarif=a.kode_tarif','left');
		$this->db->join('mt_master_tarif d','d.kode_tarif=a.kode_referensi','left');
		$this->db->where('a.kode_tarif', $kode_tarif);
		$this->db->group_by('b.nama_bagian, c.nama_tarif, d.nama_tarif');
