...
$(document).ready(function(){
    ...
    $('#formRefMemberByNoCard').ajaxForm({
      beforeSend: function() {
        achtungShowLoader();  
      },
    ...
    <!-- PAGE CONTENT BEGINS -->
      <div class="widget-body">
        <div class="widget-main no-padding">
          <form class="form-horizontal" method="post" id="formRefMemberByNoCard" action="<?php echo base_url().'ws_bpjs/ws_index/searchMember'?>" enctype="multipart/form-data" autocomplete="off">
            <br>
            ...
            <div class="form-group">
              <label class="control-label col-md-2">Tanggal Pelayanan SEP</label>
              <div class="col-md-2">
                <input type="hidden" name="jenis_kartu" value="bpjs">
              ...
              <div class="col-md-3" style="margin-left:-20px">
                <input name="nokartu" id="nokartu" value="" placeholder="Masukan No Kartu BPJS" class="form-control" type="text" >
              </div>
