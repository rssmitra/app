...
$(document).ready(function(){
    ...
    oTable = $('#dynamic-table-surat-kontrol-by-noka').DataTable({ 
    ...
    var no_mr = '<?php echo isset($_GET['no_mr'])?$_GET['no_mr']:''?>';
                    ...
                    <div class="col-md-12 no-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="radio">
                                        <label>
                                        <input name="search_by" type="radio" class="ace" value="1" checked/>
                                        <span class="lbl"> Tanggal Entri</span>
                                        </label>
                                        <label>
                                        <input name="search_by" type="radio" class="ace" value="2" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                            <div class="input-group">
                                <input name="tglAwal" id="tglAwal" value="<?php echo date('Y-m-d')?>" placeholder="ex : yyyy-MM-dd" class="form-control date-picker" type="text" data-date-format="yyyy-mm-dd">
                                <span class="input-group-addon">
                                    <i class="ace-icon fa fa-calendar"></i>
                                </span>
                                </div>
