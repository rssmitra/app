    ...
    $('#formSearchRujukanByNoRujukan').ajaxForm({
      ...
      complete: function(xhr) {    
        ...
        if(jsonResponse.status == 200){
          ...
          var rujukan = jsonResponse.result;
          var peserta = jsonResponse.result.peserta;
          console.log(jsonResponse.result.peserta);

          // data peserta
          $('#noKartu').text(peserta.noKartu);
          $('#nama').text(peserta.nama);
          $('#noMr').text(peserta.mr.noMr);
          $('#jk').text(peserta.sex);
          $('#tglLahir').text(peserta.tglLahir);
          $('#noTelp').text(peserta.mr.noTelepon);
          ...
          $('#provPerujuk').text(rujukan.provPerujuk.nama);
          // form
          $('#tglRujukan').val(rujukan.tglRujukan);
          $('#inputKeyDiagnosa').val(rujukan.diagnosa.nama);
          $('#inputKeyDiagnosaKodeHidden').val(rujukan.diagnosa.kode);
          $('#inputKeyPoli').val(rujukan.poliRujukan.nama);
          $('#inputKeyPoliKodeHidden').val(rujukan.poliRujukan.kode);
          ...
          <form class="form-horizontal" method="post" id="formSearchRujukanByNoRujukan" action="<?php echo base_url().'ws_bpjs/ws_index/searchRujukan'?>" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
              ...
              <select name="flag" class="form-control">
                  <option value="">-Silahkan Pilih-</option>
                  <option value="noRujukan">Nomor Rujukan</option>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="input-group">
                  <input type="text" name="keyvalue" class="form-control search-query" placeholder="Masukan Nomor">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    ...
                    <input id="inputKeyPoliKodeHidden" class="form-control" name="poliRujukanKode" type="text" placeholder="Masukan keyword minimal 3 karakter" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <input id="inputKeyDiagnosaKodeHidden" class="form-control" name="inputKeyDiagnosaKodeHidden" type="text" placeholder="Masukan keyword minimal 3 karakter" />
                </div>
            </div>
