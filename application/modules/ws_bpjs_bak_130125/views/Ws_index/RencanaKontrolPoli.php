...
$(document).ready(function(){
    ...
    $('input[type=radio][name=JnsKontrol]').change(function () {

        if (this.value == 1) {
            $('#txt_change').text('No Kartu BPJS');
        }
        if (this.value == 2) {
            $('#txt_change').text('No SEP');
        }
    });
            ...
            <div class="widget-main no-padding">
                ...
                <form class="form-horizontal" method="post" id="form_search" action="ws_bpjs/Ws_index/find_data"  enctype="Application/x-www-form-urlencoded" >
                    ...
                    <div class="col-md-12 no-padding">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><span id="txt_change">No Kartu BPJS</span></label>
                            <div class="col-md-3">
                        ...
                        <table id="dynamic-table" base-url="ws_bpjs/Ws_index/get_rencana_kontrol_poli" class="table">
                            <thead>
                            <tr style="background: #add46d;">  
                                <th width="30px" class="center">No</th>
                                <th width="80px">Kode Poli</th>
                                <th>Nama Poli</th>
                                <th width="170px">Kapasitas</th>
                                <th width="170px">Jumlah Rencana Kontrol</th>
                                <th width="170px">Persentase</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
