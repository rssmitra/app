    ...
    <!-- PAGE CONTENT BEGINS -->
        <div class="widget-body">
            <div class="widget-main no-padding">
                ...
                <form class="form-horizontal" method="post" id="form_search" action="ws_bpjs/Ws_index/find_rencana_kontrol_by_sep"  enctype="Application/x-www-form-urlencoded" >

                    <div class="col-md-12 no-padding">
                        <p style="font-weight: bold">PENCARIAN SURAT KONTROL DENGAN NOMOR SEP</p>
