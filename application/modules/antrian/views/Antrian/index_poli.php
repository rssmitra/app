...
<br>
	...
	<div class="col-xs-6">
		<img alt="" src="<?php echo base_url().COMP_ICON?>" width="80" style="margin:5px 20px;float:left">
			<h3 id="id_header" style="margin:0;text-align:left;font-size:30px;color:#333"><?php echo COMP_LONG?></h3>
			<p style="font-family: Helvetica;margin:0;text-align:left; width: 90%"><b><?php echo COMP_ADDRESS?></b></p>
	</div>
	<br>
	<div class="row" style="margin-top:5% !important" >
	<h2 class="center animate" style="font-size:250%"><b id="title_tipe_antrian">ANTRIAN POLI/KLINIK RAWAT JALAN</b></h2>
		<div id="refresh2">  
			<div class="col-xs-12" id="loket_refresh">
				<?php 
					
					$arr_color = array('lightblue'); 
				...
				<?php foreach($klinik as $row_modul) : ?>
					...
					<!-- small box -->
					<button class="shadow" style="border:none;text-decoration: none;border-radius:10px;margin-bottom:20px;height:150px !important;width:100%;text-align:left;padding-bottom:20px;background:<?php echo $arr_color[0]?>;">
