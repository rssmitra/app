...
class Reg_klinik extends MX_Controller {
    ...
    public function processRegisterNSEP(){
        ...
        {                       
            ...
            echo json_encode(array('status' => 200, 'message' => 'Proses Berhasil Dilakukan', 'no_mr' => '00211762', 'no_registrasi' => 987625, 'is_new' => 'N', 'type_pelayanan' => 'create_sep', 'dokter' => 'AMIN', 'poli' => 'JAN', 'nasabah' => 'BPJS', 'nama_pasien' => 'AMIN' ));
