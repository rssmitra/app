         ...
         {                       
            ...
            if($_POST['jenis_instalasi']=='RJ'){
                if($_POST['kode_perusahaan'] == 120){
                    ...
                    // apakah sudah pernah bridging
                    $has_bridging = $this->db->get_where('tc_pesanan', array('id_tc_pesanan' => $id));
                    ...
                    if($has_bridging->num_rows() == 0){
                        // echo '<pre>';print_r($data);die;
                        $result = $this->Ws_index->insertRencanaKontrol($data);
                    }else{
                        if($has_bridging->row()->is_bridging != 1){
                            $result = $this->Ws_index->insertRencanaKontrol($data);
                        }else{
                            ...
                            $result = $this->Ws_index->updateRencanaKontrol($data_for_update);
                        }
                    }
