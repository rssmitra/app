...
<div class="form-group">
      ...
      <label class="control-label col-sm-3" for="Province">*Klinik</label>
...
<div class="form-group">
  ...
  <label class="control-label col-sm-3">Paket ?</label>
...
<div class="form-group" id="odc_tindakan">
      ...
      <label class="control-label col-sm-3" for="Province">*Rencana Tindakan</label>
...
<div class="form-group">
      ...
      <label class="control-label col-sm-3" for="Province">*Dokter</label>
