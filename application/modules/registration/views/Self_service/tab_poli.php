<div class="row">
    ...
    <!-- small box -->
        <div class="small-box <?php echo array_shift($arr_color)?>" style="min-height: 115px; border-radius: 10px !important">
            <div class="inner" style="line-height: 13px; min-height: 90px" onclick="select_dokter_poli(<?php echo $row->jd_kode_dokter?>, '<?php echo $row->jd_kode_spesialis?>', <?php echo $row->jd_id?>)">
