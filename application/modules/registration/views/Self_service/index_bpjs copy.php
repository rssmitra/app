      ...
      $.ajax({
        ...
        //   achtungHideLoader();
          if(response.status==200){
            ...
            /*show hidden*/
            $('#formSearchKodeBooking').hide('fast');
          ...
          //   $('#noMR').val(response.data.no_mr);
			...
			alert('Tidak ada data ditemukan !'); return false;
          }
...
<section class="content-green subscribe-area" id="formSearchKodeBooking">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="section-title">
					<h2>Cek Kode Perjanjian Anda Disini</h2>
					<span></span>
					<p>
						Masukan Kode Perjanjian anda, lalu siapkan Surat Rujukan dari Puskesmas untuk cetak Surat Eligibilitas Pasien (SEP)
					</p>
				</div>
			</div>
		</div>
							...
							<li>
								<div class="subscribe-field">
									<div class="form-group">
										<input type="text" placeholder="Masukan Kode Booking atau Perjanjian" class="input-field" style="font-size:18px;" id="kodeBooking" name="kodeBooking">
									</div>
								</div>
							</li>
							<li>
								<div class="subscribe-btn">
									<a href="#!" class="seo-btn" id="btnSearchKodeBooking">
										Cari Data
...
<section class="content-white testimonial" id="resultSearchKodeBooking" style="padding-bottom: 20px; display: none">
	<div class="container">
