...
$(document).ready(function(){
  ...
  url = (kode_bagian!=0)?'registration/Riwayat_pasien_ranap/get_data?bagian_tujuan='+kode_bagian+' ':'registration/Riwayat_pasien_ranap/get_data';
...
function find_data_reload(result){
  ...
  oTable.ajax.url('registration/Riwayat_pasien_ranap/get_data?'+result.data).load();
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="registration/Riwayat_pasien_ranap" class="table table-bordered table-hover">
       <thead>
        <tr>  
