...
function saveRow(no_registrasi){  
  ...
  preventDefault();
  $.ajax({
      url: 'registration/Riwayat_reg_sep_fail/updateNoSEP',
      type: "post",
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="registration/Riwayat_reg_sep_fail/find_data">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
          ...
          <label class="control-label col-md-2">Tujuan Kunjungan</label>
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="registration/Riwayat_reg_sep_fail" class="table table-bordered table-hover">
       <thead>
        <tr>  
