  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4 class="glr-form-title">Laporan Penerimaan Barang Gudang</h4>
        <form name="kinerja_dr" class="form-horizontal" method="post" id="form_search" action="<?php echo base_url()?>laporan/Global_report/show_data_penerimaan" target="blank">
        <!-- hidden form -->
          <input type="hidden" name="flag" value="<?php echo $flag?>">
          <input type="hidden" name="title" value="Laporan Penerimaan Barang Gudang">
