  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4 class="glr-form-title">Rekap Pembelian Barang Berdasarkan Supplier</h4>
        <form class="form-horizontal" method="post" id="form_search" action="<?php echo base_url()?>laporan/Global_report/show_rekap_supplier" target="blank">
        <!-- hidden form -->
          <input type="hidden" name="flag" value="<?php echo $flag?>">
          <input type="hidden" name="title" value="Rekap Pembelian Barang Berdasarkan Supplier">
         
           <div class="form-group">
            <label class="control-label col-md-2">Jenis Gudang</label>
              <div class="col-md-2">
