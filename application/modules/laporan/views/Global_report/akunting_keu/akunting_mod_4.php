  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4 class="glr-form-title">Laporan IF (Unit farmasi) Perbulan</h4>
    ...
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        <br>
        <h4 class="glr-form-title">Laporan IF (Unit farmasi) Pertahun</h4>
     ...
     <div class="col-xs-12">
      ...
      <div class="col-md-12">
        <br>
        <h4 class="glr-form-title">Laporan Rekap IF (Unit farmasi) Per-unit</h4>
