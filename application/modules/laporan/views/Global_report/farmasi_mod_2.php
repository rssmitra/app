  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4>Laporan Stok Akhir Barang Medis Berdasarkan Mutasi Tanggal Terakhir</h4>
        ...
        <!-- hidden form -->
          ...
          <input type="hidden" name="title" value="Laporan Stok Akhir Barang Medis Berdasarkan Mutasi Tanggal Terakhir">
