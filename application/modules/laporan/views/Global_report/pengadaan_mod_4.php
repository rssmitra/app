  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4 class="glr-form-title">Laporan Permintaan Pembelian</h4>
        <form class="form-horizontal" method="post" id="form_search" action="<?php echo base_url()?>laporan/Global_report/show_data_pp">
        <!-- hidden form -->
          <input type="hidden" name="flag" value="<?php echo $flag?>">
          <input type="hidden" name="title" value="Laporan Permintaan Pembelian">
          ...
          <div class="form-group">
            <label class="control-label col-md-2">Status</label>
               <div class="col-md-4">
                <select name="status">
                  <option value="0">-- ACC -- </option>
                  <option value="1">-- Tidak ACC --</option>
                </select>
              </div>
          </div>
