							...
							<div class="col-xs-12">
								...
								<div id="accordion" class="accordion-style1 panel-group">
									...
									<div class="panel-collapse collapse" id="collapseAkunting" aria-expanded="false" style="height: 0px;">
										<div class="panel-body">
											<ol>
												...
												<li><a href="<?php echo base_url().'laporan/Global_report/master_tarif'?>">Master Tarif</a></li>
											</ol>
										</div>
									</div>
									</div>
									...
									<div class="panel-collapse collapse" id="collapsePurchasing" aria-expanded="false" style="height: 0px;">
										<div class="panel-body">
										<ol>
											<li><a href="<?php echo base_url().'laporan/Global_report/pengadaan?mod=1'?>">Laporan Stok Akhir Barang Non Medis Berdasarkan Tanggal Terakhir Stok <i class="fa fa-star orange bigger-120"></i> </a></li>
									...
									<div class="panel-collapse collapse" id="collapseKunjunganRj" aria-expanded="true" style="">
										...
										<ol>
											...
											<li><a href="<?php echo base_url().'laporan/Global_report/kunjungan?mod=5'?>">Data Keterlambatan Kunjungan Praktek Dokter</a> <i class="fa fa-star orange bigger-120"></i> </li>
										</ol>
										</div>
									</div>
									</div>
