  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <center>
        ...
        Periode <?php echo $this->tanggal->formatDate($tgl1) ?> s/d <?php echo $this->tanggal->formatDate($tgl2) ?>
      </center>
        ...
        <tbody>
          ...
          $no = 0; 
            ...
            <tr class="contentTable">
              ...
              <td align="right"><?php echo $harga_beli; ?>&nbsp;</td>
              <td align="right"><?php echo $jumlah_penerimaan;?>&nbsp;</td>
              <td align="right"><?php echo $harga_jumlah;?>&nbsp;</td>
            </tr>
          <?php  } ?>
          <tr>
            <td colspan="8" align="right">TOTAL</td>
            <td align="right"><?php echo array_sum($arr_total) ?></td>
          </tr>           
        </tbody>
      </table>
