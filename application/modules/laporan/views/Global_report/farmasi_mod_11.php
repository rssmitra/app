  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <br>
        <h4 class="glr-form-title">Laporan Pemakaian Unit</h4>
        <form class="form-horizontal" method="post" id="form-default" action="<?php echo base_url()?>laporan/Global_report/show_data_pemakaian_unit">
        <!-- hidden form -->
          <input type="hidden" name="flag" value="<?php echo $flag?>">
          <input type="hidden" name="title" value="Laporan Pemakaian Unit">
