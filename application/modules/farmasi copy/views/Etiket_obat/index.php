  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="pelayanan/Pl_pelayanan/find_data">
      ...
      <div class="col-md-12">
        ...
        <center><h4>FORM PENCARIAN DATA PEMESANAN RESEP (<?php echo strtoupper($flag)?>) <br><small style="font-size:12px">Data yang ditampilkan saat ini adalah data per Hari ini yaitu tanggal <?php echo date('d/m/Y')?> </small></h4></center>
        <br>
      ...
      <div style="margin-top:-27px">
        <table id="dynamic-table" base-url="farmasi/Etiket_obat/get_data?flag=<?php echo $flag?>" class="table table-bordered table-hover">
          <thead>
            <tr>  
