...
<div class="row" style="top:50%; left: 50%" id="asum_main_view">
  ...
  <p style="text-align: center; font-size: 2em; font-weight: bold; color: green">KIOSK PELAYANAN PASIEN<br>UMUM & ASURANSI</p>
        ...
        <div class="widget-body">
          <div class="widget-main padding-4" data-size="125" style="position: relative;">
            <div style="min-height: 350px;">
              <div class="content">
                <div class="center" style="padding-top: 10px;">
                <img src="<?php echo base_url()?>assets/kiosk/icon-rad.png" height="100" alt="">
                  <br>
                  <br>
                  <span style="font-size: 18px;font-weight: bold; padding-top: 10px">Radiologi</span>
                  <p style="align: justify; padding-top: 10px; min-height: 100px">Pendaftaran Mandiri Pasien Umum tujuan ke Radiologi untuk USG, Rontgen dan Pemeriksaan Lainnya</p>
                </div>
                <div class="center">
                  <a href="#" class="btn btn-lg" onclick="select_penunjang('050201')"  style="background: green !important; border-color: #b7d9b74f">Klik Disini</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div style="min-height: 350px;">
              <div class="content">
                ...
                <img src="<?php echo base_url()?>assets/kiosk/icon-fisio.png" height="100" alt="">
                  ...
                  <p style="align: justify; padding-top: 10px; min-height: 100px">Pendaftaran Mandiri Pasien Umum tujuan ke Fisioterapi.</p>
                </div>
                <div class="center">
...
<div id="konfirmasi_kunjungan" style="display: none">
  <div class="center" style="padding-top: 100px">
    ...
    <br><br><br><br>
    <button type="button" class="btn btn-xs btn-primary" style="height: 45px !important;font-size: 20px;min-width: 320px; background: green !important; border-color: green" onclick="getMenu('kiosk/Kiosk/umum_asuransi')"><i class="fa fa-arrow-left bigger-150"></i> Ganti Tujuan Kunjungan </button>
