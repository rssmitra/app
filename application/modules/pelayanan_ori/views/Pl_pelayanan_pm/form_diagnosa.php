...
<script type="text/javascript">
  ...
  $('#pl_diagnosa').typeahead({
    ...
    $('#btn_save_diagnosa').click(function (e) {  

        e.preventDefault();
        /*process add obat*/
        $.ajax({
            url: "pelayanan/Pl_pelayanan/processSaveDiagnosa",
            ...
            if(response.status==200) {
                $('#div_btn_save_diagnosa').hide();
                $('#msg_success').html('Sukses !');
            }else{
...
<div class="form-group" style="padding-top: 10px" id="div_btn_save_diagnosa">
    <label class="control-label col-sm-2" for="">&nbsp;</label>
    <div class="col-sm-4" style="margin-left:6px">
       <button type="button" class="btn btn-xs btn-primary" id="btn_save_diagnosa"> <i class="fa fa-save"></i> Simpan Data </button>
    </div>
</div>