...
function selesaikanKunjungan(){
  ...
  $('#form_default_pelayanan').load('pelayanan/Pl_pelayanan_ri/form_end_visit?mr='+noMr+'&id='+$('#kode_ri').val()+'&no_kunjungan='+$('#no_kunjungan').val()+''); 
      ...
      <form class="form-horizontal" method="post" id="form_pelayanan" action="#" enctype="multipart/form-data" autocomplete="off" >      
          ...
          <!-- end action form  -->
            ...
            <div class="form-group" style="margin-bottom:3px">
                ...
                <div class="col-sm-4">
                  <textarea name="pl_diagnosa_awal" id="pl_diagnosa_awal" class="form-control" style="height:50px !important" <?php echo isset($riwayat->diagnosa_akhir)?'readonly':''?> placeholder="Masukan keyword ICD 10" ><?php echo isset($riwayat->diagnosa_awal)?$riwayat->diagnosa_awal:''?></textarea>  
                </div>
                <label class="control-label col-sm-2" for="">Anamnesa</label>
                <div class="col-sm-4">
                  <textarea name="pl_anamnesa" class="form-control" style="height:50px !important"><?php echo isset($riwayat->anamnesa)?$riwayat->anamnesa:''?></textarea>                  
                </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom:5px">
                ...
                <div class="col-sm-4">
                  <textarea name="pl_diagnosa" id="pl_diagnosa" class="form-control" style="height:50px !important" <?php echo isset($riwayat->diagnosa_akhir)?'readonly':''?> placeholder="Masukan keyword ICD 10" ><?php echo isset($riwayat->diagnosa_akhir)?$riwayat->diagnosa_akhir:''?></textarea> 
                ...
                <div class="col-sm-4">
                  <textarea name="pl_pengobtan" class="form-control" style="height:50px !important"><?php echo isset($riwayat->pengobatan)?$riwayat->pengobatan:''?></textarea> 
                </div>
            </div>

            <div class="form-group" id="btn_submit_diagnosa" style="<?php echo isset($riwayat->diagnosa_akhir)?'display:none':''?>">
                <label class="control-label col-sm-2" for=""></label>
                <div class="col-sm-7" style="margin-left:1px">
                  <a href="#" class="btn btn-sm btn-danger" id="btn_hide_submit_diagnosa" onclick="UnEditDiagnosa()" style="display:none"> <i class="fa fa-angle-double-left"></i> Sembunyikan</a> <a href="#" class="btn btn-sm btn-primary" id="btn_add_diagnosa"><i class="fa fa-save"></i> Simpan</a> 
                </div>
            </div>
