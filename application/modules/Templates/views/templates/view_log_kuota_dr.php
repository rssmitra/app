<br>
<span style="font-weight: bold; margin-top: 10px">INFORMASI KUOTA DOKTER</span>
  ...
  <div class="col-md-12">
    <table class="table table-bordered table-hover" style="background-color: #a6d3f966">
      <tr>
        ...
        <td style="width: 30%">
          Terdaftar <br>
          <span style="font-size: 18px; font-weight: bold; text-align: right"><a href="#" onclick="show_modal('Templates/References/view_pasien_terdaftar_current?kode_dokter=<?php echo $kode_dokter; ?>&kode_spesialis=<?php echo $kode_bagian; ?>', 'PASIEN TERDAFTAR HARI INI')"><?php echo $terdaftar?></a></span>
        </td>
        <td style="width: 30%">
          Sisa Kuota <br>
          <?php
