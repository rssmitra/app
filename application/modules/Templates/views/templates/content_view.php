  ...
  <body class="no-skin">
    ...
    <script type="text/javascript">
      ...
      function hitung_usia(DOB){
        ...
        var ageYear = nowyear - byr;
        var ageMonth = nowmonth - bmth;
        var ageDay = nowday - bdy;

        if (ageDay < 0) {
          ageMonth--;
          var prevMonth = new Date(nowyear, nowmonth, 0).getDate();
          ageDay += prevMonth;
        }
        if (ageMonth < 0) {
          ageYear--;
        ...
        return ageYear + " th " + ageMonth + " bln " + ageDay + " hr";
      }
      ...
      function getLiburNasional(year){
        ...
        if(year == 2026){
            var dataLiburNasional = ["1-1-2026", "16-1-2026", "17-2-2026", "19-3-2026", "21-3-2026", "22-3-2026", "3-4-2026", "5-4-2026", "1-5-2026", "14-5-2026", "27-5-2026", "31-5-2026", "1-6-2026", "16-6-2026", "17-8-2026", "25-8-2026", "25-12-2026"];
        }
