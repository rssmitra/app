          ...
          <table style="width: 100%">
            <tr>
              ...
              <p>
                ...
                <span style="font-weight: bold;">ANJURAN DOKTER :</span><br><?php echo nl2br($value->pengobatan); ?>
              </p>
              <b>RESEP & PENUNJANG MEDIS</b>
              <div id="accordion_resep" class="accordion-style1 panel-group">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion_resep" href="#collapsePenunjang<?php echo $value->no_kunjungan?>" style="background: #87b87f; color: white;">
                  ...
                  <div class="panel-collapse collapse" id="collapsePenunjang<?php echo $value->no_kunjungan?>">
                    <div class="panel-body" style="background: #87b87f47">
                      <div style="padding: 5px">
                        <br>
                        <b>Laboratorium</b>
