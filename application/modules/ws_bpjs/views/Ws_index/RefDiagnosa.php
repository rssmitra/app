...
<script>
  document.getElementById("formRefDiagnosa").reset();
    ...
    <!-- PAGE CONTENT BEGINS -->
      <div class="widget-body">
        <div class="widget-main no-padding">
          <form class="form-horizontal" method="post" id="formRefDiagnosa" action="" enctype="multipart/form-data" autocomplete="off">
            <br>
            <div class="col-md-8">
              <div class="box box-danger">
                  <div class="box-body">
                      ...
                      Fungsi : Pencarian data diagnosa (ICD-10) <br>
                      ...
                      Parameter : Kode atau Nama Diagnosa <br>
