...
<div class="body">
  <table width="100%" border="0">
    <tr>
      <td width="20%" align="center"><img src="<?php echo COMP_ICON?>" alt="" width="50px"></td>
  ...
  <table style="width: 100% !important;margin-top: 10px; margin-bottom: 10px">
    <thead>
        ...
        <?php 
          ...
          $total_obat = $row_dt->jumlah + $row_dt->jumlah_7;
          $harga_total = $row_dt->harga_satuan * $total_obat;
          $arr_total[] = $harga_total;    
        ?>
          ...
          <tr>
            ...
            <td style="text-align:center; width: 10%; border-collapse: collapse"><?php echo number_format($total_obat);?></td>
            <td style="text-align:left; width: 10%; border-collapse: collapse"><?php echo $row_dt->satuan_kecil?></td>
            <td style="text-align:right; width: 15%; border-collapse: collapse"><?php echo number_format($harga_total)?></td>
          </tr>
