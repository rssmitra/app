...
class Tarif_pelayanan extends MX_Controller {
    ...
    public function form($id='')
    {
        ...
        if( $id != '' ){
            ...
            $this->breadcrumbs->push('Edit '.strtolower($this->title).'', 'Tarif_pelayanan/'.strtolower(get_class($this)).'/'.__FUNCTION__.'/'.$id);
            /*get value by id*/
            ...
            $this->breadcrumbs->push('Add '.strtolower($this->title).'', 'Tarif_pelayanan/'.strtolower(get_class($this)).'/form');
    ...
    public function show($id)
    {
        ...
        $this->breadcrumbs->push('View '.strtolower($this->title).'', 'Tarif_pelayanan/'.strtolower(get_class($this)).'/'.__FUNCTION__.'/'.$id);
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            $row[] = '<div class="center">
                        '.$this->authuser->show_button('setting/Tarif_pelayanan','R',$row_list->function_id,2).'
                        '.$this->authuser->show_button('setting/Tarif_pelayanan','U',$row_list->function_id,2).'
                        '.$this->authuser->show_button('setting/Tarif_pelayanan','D',$row_list->function_id,2).'
                      </div>'; 
    ...
    public function process()
    {
        ...
        {                       
            ...
            if($id==0){
                ...
                /*save post data*/
                $newId = $this->Tarif_pelayanan->save($dataexc);
                /*save logs*/
                ...
                /*update record*/
                $this->Tarif_pelayanan->update(array('function_id' => $id), $dataexc);
                $newId = $id;
                /*save logs*/
    ...
    public function delete()
    {
        ...
        $toArray = explode(',',$id);
        if($id!=null){
            if($this->Tarif_pelayanan->delete_by_id($toArray)){
