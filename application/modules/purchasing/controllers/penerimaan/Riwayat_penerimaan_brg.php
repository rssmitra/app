...
class Riwayat_penerimaan_brg extends MX_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        /*breadcrumb default*/
        $this->breadcrumbs->push('Index', 'purchasing/penerimaan/Riwayat_penerimaan_brg');
    ...
    { 
        ...
        $data = array(
            'title' => 'Riwayat Penerimaan Barang '.$title,
            'breadcrumbs' => $this->breadcrumbs->show(),
            'flag' => $_GET['flag'],
        );
        /*load view index*/
        $this->load->view('penerimaan/Riwayat_penerimaan_brg/index', $data);
    }
    ...
    public function form($id='')
    {
        ...
        $this->breadcrumbs->push('Edit '.strtolower($this->title).'', 'Riwayat_penerimaan_brg/'.strtolower(get_class($this)).'/'.__FUNCTION__.'/'.$id);
        ...
        /*title header*/
        $data['title'] = 'Riwayat Penerimaan Barang '.$title;
         /*show breadcrumbs*/
        $data['breadcrumbs'] = $this->breadcrumbs->show();

        $this->load->view('penerimaan/Riwayat_penerimaan_brg/form', $data, false);
    ...
    function get_barang_po_penerimaan()
    {
        ...
        $dt_detail_brg = $this->Riwayat_penerimaan_brg->get_detail_table($_GET['flag'], $_GET['id']);
        $getData = array();
        ...
        $this->load->view('penerimaan/Riwayat_penerimaan_brg/view_brg_po', $data);
    ...
    public function form_input_batch()
    {
        ...
        $data['flag'] = $flag;
        // search data
        $dt = $this->Riwayat_penerimaan_brg->get_brg_po_by_id($_GET);
        ...
        $this->load->view('penerimaan/Riwayat_penerimaan_brg/form_input_batch', $data, false);
    ...
    public function show_penerimaan_brg($id)
    {
        ...
        /*load form view*/
        $this->load->view('penerimaan/Riwayat_penerimaan_brg/view_penerimaan_brg', $data);
    }
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            // $row[] = '<div class="center">'.$row_list->jml_diterima.'</div>';
            $row[] = '<div class="center">
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Riwayat_penerimaan_brg->count_all(),
                        "recordsFiltered" => $this->Riwayat_penerimaan_brg->count_filtered(),
                        "data" => $data,
                );
        ...
        {                       
            ...
            if( $_POST['submit'] == 'header' ){
                ...
                $dataexc = array(
                    ...
                    'kode_penerimaan' => $this->regex->_genRegex( $val->set_value('kode_penerimaan'), 'RGXQSL'),
                ...
                if($id==0){
                    ...
                    $last_id = $this->Riwayat_penerimaan_brg->save($table, $dataexc);
                    ...
                    /*print_r($dataexc);die;*/
                    /*update record*/
                    $this->Riwayat_penerimaan_brg->update($table, array('id_penerimaan' => $id), $dataexc);
                    $newId = $id;
            ...
            if( $_POST['submit'] == 'penerimaan_selesai' ){
                ...
                foreach ($_POST['is_checked'] as $keys => $rows) {
                    ...
                    $dataexc["jumlah_pesan"] = $_POST['jml_pesan'][$rows];
                    $dataexc["jumlah_kirim"] = $_POST['terima_'.$rows.''];
                    ...
                    // insert to table
                    $exc = $this->Riwayat_penerimaan_brg->save($table.'_detail', $dataexc);
            ...
            {
                $this->db->trans_commit();
                echo json_encode(array('status' => 200, 'message' => 'Proses Berhasil Dilakukan', 'flag' => $_POST['flag'], 'id' => isset($newId)?$newId:0, 'id_tc_po' => $_POST['id_tc_po'], 'action'=> $_POST['submit'] , 'data' => $dataexc));
            }
        }
    }
        ...
        {                       
            ...
            if( $_POST['submit'] == 'input_batch' ){
                ...
                if($id==0){
                    $dataexc['created_date'] = date('Y-m-d H:i:s');
                    $dataexc['created_by'] = json_encode(array('user_id' =>$this->regex->_genRegex($this->session->userdata('user')->user_id,'RGXINT'), 'fullname' => $this->regex->_genRegex($this->session->userdata('user')->fullname,'RGXQSL')));
                    $this->Riwayat_penerimaan_brg->save('tc_penerimaan_brg_batch_log', $dataexc);
                    ...
                    /*print_r($dataexc);die;*/
                    /*update record*/
                    $this->Riwayat_penerimaan_brg->update('tc_penerimaan_brg_batch_log', array('id_tc_batch_log' => $id), $dataexc);
                    $newId = $id;
    ...
    public function print_preview_penerimaan()
    {
