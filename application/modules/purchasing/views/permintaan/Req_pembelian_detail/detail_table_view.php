...
<div class="det-wrap">
  <div class="det-hdr">
    ...
    <span style="margin-left:auto;font-weight:400;opacity:.85"><?php echo isset( $dt_detail_brg[0] ) ? $dt_detail_brg[0]->kode_permohonan : 'Tidak ada data'; ?></span>
  </div>
  <table class="det-tbl">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      ?>
        ...
        <?php endforeach; else: echo '<tr><td colspan="8" class="center" style="color:#888;font-style:italic;padding:12px">Tidak ada barang ditemukan</td></tr>'; endif; ?>
    </tbody>
  </table>
</div>
