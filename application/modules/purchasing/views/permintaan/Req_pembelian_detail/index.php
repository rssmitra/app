...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="pelayanan/Pl_pelayanan_ri/find_data">
        ...
        <center>
            <h4>PERMINTAAN PEMBELIAN GUDANG</h4>
        </center>
        ...
        <div style="margin-top:-27px">
          ...
          <table id="dynamic-table" base-url="purchasing/permintaan/Req_pembelian" data-id="flag=" url-detail="purchasing/permintaan/Req_pembelian/get_detail" class="table table-bordered table-hover">
            <thead>
            <tr>  
