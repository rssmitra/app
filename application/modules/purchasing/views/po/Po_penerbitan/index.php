...
<style>
  ...
  .alert-notice { background: #fff8e1; border: 1px solid #ffc107; border-radius: 4px; padding: 8px 14px; font-size: 12px; color: #6d4c41; margin-bottom: 12px; display: flex; align-items: center; gap: 8px; }
</style>
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="alert-notice">
      ...
      Data usulan pembelian yang belum dibuatkan PO melebihi 14 hari semenjak diusulkan akan expired secara otomatis, dan harus membuat usulan pembelian baru kembali.
    </div>
    ...
    <form class="form-horizontal" method="post" id="form_search" action="purchasing/po/Po_penerbitan/find_data?flag=<?php echo $flag?>" autocomplete="off">
      ...
      <div class="srch-card">
        ...
        <div class="srch-actions">
          ...
          <a href="#" class="btn btn-sm btn-danger" id="btn_create_po" style="margin-left:auto"><i class="fa fa-file"></i> Purchase Order (PO)</a>
        </div>
      </div>

      <div class="tbl-wrap">
        <div class="tbl-hdr">
          <i class="fa fa-table"></i> Data Penerbitan PO
