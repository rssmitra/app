        ...
        <form class="form-horizontal" method="post" id="form_cart" action="<?php echo base_url().$url?>" enctype="multipart/form-data" style="margin-top: -10px" autocomplete="off">
          ...
          <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <?php 
                  echo $this->master->custom_selection($params = array('table' => 'mt_bagian', 'id' => 'kode_bagian', 'name' => 'nama_bagian', 'where' => array()), '060201' , 'dari_unit', 'dari_unit', 'chosen-select form-control', '', '') ?>
              </div>
            </div>
