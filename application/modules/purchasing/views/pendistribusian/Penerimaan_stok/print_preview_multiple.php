...
<table class="table-utama" style="width: 100% !important;">
  <thead>
      <tr style="background-color: #e4e7e8;color: #0a0a0a;font-weight: bold; border: 1px solid black; border-collapse: collapse">
        ...
        <td style="text-align:center; width: 8%; border: 1px solid black; border-collapse: collapse">Jumlah<br>Permintaan</td>
        <td style="text-align:center; width: 8%; border: 1px solid black; border-collapse: collapse">Satuan Kecil</td>
        <td style="text-align:center; width: 8%; border: 1px solid black; border-collapse: collapse">Rasio</td>
        <td style="text-align:center; width: 8%; border: 1px solid black; border-collapse: collapse">Konversi<br>Satuan Besar</td>
      </tr>
  </thead>
  <tbody>
      <?php 
      ...
      ?>
          ...
          <td style="text-align:center; border: 1px solid black; border-collapse: collapse"><?php $konversi = $row_dt['barang']->jumlah_permintaan / $row_dt['barang']->rasio; 
          $modulus = $row_dt['barang']->jumlah_permintaan % $row_dt['barang']->rasio;
          $txt_modulus = ( ($row_dt['barang']->jumlah_permintaan % $row_dt['barang']->rasio) == 0 ) ? '' : ' + '.$modulus.' '.$row_dt['barang']->satuan_kecil ;

          echo ( $konversi != 0 ) ? number_format($konversi).' '.$row_dt['barang']->satuan_besar : '' ;
          echo $txt_modulus; 
          ?>
          </td>

          <!-- <td style="text-align:center; border: 1px solid black; border-collapse: collapse"><?php $konversi = $row_dt['barang']->jumlah_permintaan * $row_dt['barang']->rasio; echo number_format($konversi).' '.$row_dt['barang']->satuan_kecil; ?></td> -->
          </tr>
      <?php endforeach;?>
  </tbody>
</table>
