...
<table class="table-utama" style="width: 100% !important;">
  ...
  <tbody>
      <?php $no=0; foreach($dt_detail_brg as $row_dt) : $no++?>
          ...
          <td style="text-align:center; border: 1px solid black; border-collapse: collapse"><?php echo $row_dt->jumlah_permintaan?></td>
...
<p>
  Keterangan : <br><?php echo ($permintaan->catatan)?$permintaan->catatan:'-'?>
</p>
<br>
