...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="purchasing/pendistribusian/Riwayat_retur/find_data?flag=<?php echo $flag?>">
      ...
      <div class="srch-card">
        ...
        <div class="srch-card-body">
          ...
          <div class="form-group" style="margin-bottom:8px">
            ...
            <div class="col-md-5">
              <?php echo $this->master->custom_selection(array('table'=>'mt_bagian','id'=>'kode_bagian','name'=>'nama_bagian','where'=>array()), '', 'kode_bagian', 'kode_bagian', 'form-control input-sm', '', '') ?>
            </div>
          </div>
      ...
      <div class="tbl-wrap">
        <div class="tbl-hdr">
          <i class="fa fa-table"></i> Data Riwayat Retur
