  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="purchasing/pendistribusian/Distribusi_permintaan/find_data?flag=<?php echo $flag?>">
      ...
      <div class="clearfix" style="margin-bottom:-5px">
          <!-- <?php echo $this->authuser->show_button('purchasing/pendistribusian/Distribusi_permintaan?flag='.$flag.'','C','',7)?> -->
          <?php echo $this->authuser->show_button('purchasing/pendistribusian/Distribusi_permintaan?flag='.$flag.'','D','',5)?>
