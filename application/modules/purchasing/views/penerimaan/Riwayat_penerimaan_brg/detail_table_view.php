      ...
      <thead>
        ...
        <?php 
          ...
          foreach($po_data as $key_dt=>$row_dt) : $no++; 
            $tr_color = ($row_dt->jumlah_besar > $row_dt->jumlah_kirim_decimal) ? '<i class="fa fa-exclamation-triangle red"></i>' : '<i class="fa fa-check-circle green"></i>' ;
        ?>
            <tr>
              ...
              <td style="text-align:center; border: 1px solid #cecaca; border-collapse: collapse"><?php echo ($row_dt->jumlah_kirim_decimal)?$row_dt->jumlah_kirim_decimal:0; ?> <?php echo $tr_color; ?> </td>
