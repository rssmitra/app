...
<div class="page-header-idx">
  <h1><?php echo $title?> <small style="font-size:13px;color:#888;font-weight:400"><i class="ace-icon fa fa-angle-double-right"></i> <?php echo isset($breadcrumbs)?$breadcrumbs:''?></small></h1>
</div>
    ...
    <form class="form-horizontal" method="post" id="form_search" action="purchasing/penerimaan/Penerimaan_brg/find_data?flag=<?php echo $flag?>" autocomplete="off">
        ...
        <div class="srch-card-body">
          ...
          <div class="form-group" style="margin-bottom:8px">
            ...
            <div id="div_supplier" style="display:none">
              <div class="col-md-3">
                <input id="inputSupplier" class="form-control input-sm" type="text" placeholder="Ketik min. 3 karakter..." autocomplete="off"/>
                <input type="hidden" name="kodesupplier" id="kodesupplier" value="">
              </div>
            </div>
      ...
      <div class="tbl-wrap">
        <div class="tbl-hdr">
          ...
          <span style="margin-left:auto;font-weight:400;font-size:11px;opacity:.85">Gudang <?php echo ($flag=='medis')?'Medis':'Non Medis'?></span>
        </div>
