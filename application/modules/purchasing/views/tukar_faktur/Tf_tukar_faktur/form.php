...
<style>
  ...
  .frm-supplier-info { padding: 10px 0 12px; border-bottom: 1px solid #d0dce8; margin-bottom: 14px; }
  .frm-supplier-info .sup-name { font-size: 16px; font-weight: 700; color: #1a4f8a; }
  .frm-supplier-info .sup-addr { font-size: 11px; color: #666; }
  .ttf-tbl { width: 100%; border-collapse: collapse; font-size: 12px; margin-top: 10px; }
  .ttf-tbl thead tr { background: #2c6fad; color: #fff; }
  .ttf-tbl thead th { padding: 8px 10px; text-align: center; font-weight: 600; border: 1px solid #1e5590; }
  .ttf-tbl tbody td { padding: 6px 10px; border: 1px solid #d0dce8; vertical-align: middle; }
  .ttf-tbl tbody tr:nth-child(even) { background: #f5f9fd; }
  .ttf-tbl .footer-row td { background: #eef4fb; font-weight: 600; border: 1px solid #d0dce8; padding: 6px 10px; }
</style>

<div class="frm-card">
  <div class="frm-card-hdr">
    <i class="fa fa-exchange"></i> <?php echo $title?>
    <small><i class="fa fa-angle-double-right"></i> <?php echo isset($breadcrumbs)?$breadcrumbs:''?></small>
  </div>
  <div class="frm-card-body">

    <div class="frm-supplier-info">
      <div class="sup-name"><?php echo $result[0]->namasupplier?></div>
      <div class="sup-addr"><i class="fa fa-map-marker"></i> <?php echo $result[0]->alamat?></div>
    </div>
    ...
    <form class="form-horizontal" method="post" id="form_tukar_faktur" action="<?php echo site_url('purchasing/tukar_faktur/Tf_tukar_faktur/process')?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <label class="control-label col-md-1">Jth Tempo</label>
        <div class="col-md-2">
          <div class="input-group">
      ...
      <table id="dynamic-table" base-url="purchasing/tukar_faktur/Tf_tukar_faktur" data-id="flag=<?php echo $flag?>" url-detail="purchasing/tukar_faktur/Tf_tukar_faktur/get_detail" class="ttf-tbl" style="width: 70%">
        <thead>
          <tr>
            <th width="30px">No</th>
        ...
        <tbody>
          ...
          <tr class="footer-row">
            ...
            <td align="right"><b><span id="txt_total"><?php $ttl = $ppn + array_sum($arr_total); echo number_format($ttl); ?></span></b></td>
          </tr>
      ...
      <div class="frm-actions">
        <a onclick="getMenu('purchasing/tukar_faktur/Tf_tukar_faktur/view_data?flag=<?php echo $flag?><?php echo $qry_url?>', 'tabs_form_po')" href="#" class="btn btn-sm btn-success">
