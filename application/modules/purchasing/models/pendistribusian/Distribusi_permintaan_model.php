...
class Distribusi_permintaan_model extends CI_Model {
	...
	public function get_brg_permintaan($flag, $id){
		...
		$this->db->select('a.id_tc_permintaan_inst_det, e.kode_bagian_kirim, jumlah_permintaan, jumlah_penerimaan , a.kode_brg,, c.nama_brg, c.content as rasio, c.satuan_kecil, c.satuan_besar, e.nomor_permintaan, e.jenis_permintaan, e.tgl_permintaan, f.jml_sat_kcl as jumlah_stok_sebelumnya, g.nama_bagian,CAST(c.harga_beli as INT) as harga_beli');
		...
		$this->db->group_by('a.id_tc_permintaan_inst_det, e.kode_bagian_kirim, jumlah_permintaan, jumlah_penerimaan , a.kode_brg,, c.nama_brg, c.content, c.satuan_kecil, c.satuan_besar, e.nomor_permintaan, e.jenis_permintaan, e.tgl_permintaan, f.jml_sat_kcl, g.nama_bagian, CAST(c.harga_beli as INT)');
