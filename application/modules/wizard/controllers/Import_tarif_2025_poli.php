...
class Import_tarif_2025_poli extends MX_Controller {

    /*function constructor*/
    function __construct() {

        parent::__construct();
        $this->load->model('Import_tarif_2025_poli_model');
    }
    ...
    public function import($file_name){
        ...
        foreach($sheet as $key=>$row){
            ...
            if($numrow > 4){
                ...
                //$this->Import_tarif_2025_poli_model->save_log_book($row, $klas);
                ...
                $data = [
                    ...
                    'is_active'=>'Y', 
                    'is_old'=>'N', 
                    'new_tarif_2025_poli'=>1, 
                ];

                //echo '<pre>'; print_r($data);die;
                $get_kode_tarif = $this->Import_tarif_2025_poli_model->update_tarif('mt_master_tarif_dev',$data);
    ...
    function execute_tarif_klas($klas, $row, $sheet, $kode_tarif){
        ...
        foreach ($klas as $key_klas => $val_klas) {
            ...
            foreach($is_array as $row_klas) :
                ...
                $dt_ex = $this->Import_tarif_2025_poli_model->get_detail_tarif($kode_tarif, $row_klas);
        ...
        return $this->Import_tarif_2025_poli_model->update_detail_tarif('mt_master_tarif_detail_dev',$detail_tarif);
    ...
    public function export($kode_bagian, $reff){
        /*get data*/
        $data = $this->Import_tarif_2025_poli_model->get_tarif_by_kode_bagian($kode_bagian, $reff);
    }
