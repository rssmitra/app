      ...
      complete: function(xhr) {     
        ...
        //   $('#total_payment').val(jsonResponse.count_um);
          if (jsonResponse.billing_um > 0) {
            PopupCenter('billing/Billing/print_preview?no_registrasi='+$('#no_registrasi').val()+'&flag_bill=real&status_nk=null&kode_tc_trans_kasir='+jsonResponse.kode_tc_trans_kasir+'','Cetak',1200,750);
          }
