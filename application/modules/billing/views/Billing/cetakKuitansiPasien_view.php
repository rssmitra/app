      ...
      <div class="col-xs-8">
        <table style="font-size:13px; padding-top: 30mm;" border="0">
          ...
          <tr> 
            ...
            <td width="67%">: <input name="nama_penjamin" type="text" style="border: none; width: 90%; font-size: 14px;" value="<?php echo $data->reg_data->nama_pasien?>"></input></td>
          </tr>
          <tr>
            <td width="20%" valign="top" style="font-size:13px">Terbilang </td> 
            <td width="67%" bgcolor="#EBEBEB" nowrap style="font-size:14px;">: 
            <span style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif"><i><b><?php $terbilang = new Kuitansi(); echo ucwords($terbilang->terbilang($data->kasir_data[0]->tunai))
              ?> Rupiah</b></i></span>
            </td>
          </tr> 
          <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" style="padding: 0 0 0 9mm;"> 
          <tr> 			
            ...
            <span style="font-size: 20px; font-weight: bolder; padding: 10px; border-style: solid; border-width: 5px;">Rp <?php echo number_format($data->kasir_data[0]->tunai); ?>,-</span> 
