        ...
        <div class="widget-main no-padding">
          ...
          <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('master_data/Global_parameter/process?'.http_build_query($_GET).'')?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->auto_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                    <input name="value" id="value" value="<?php echo isset($value)?$value->value:''?>" placeholder="" class="form-control" type="file" <?php echo ($flag=='read')?'readonly':''?> >
                </div>
              </div>
