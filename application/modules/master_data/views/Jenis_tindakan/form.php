    ...
    <!-- PAGE CONTENT BEGINS -->
      <div class="widget-body">
        <div class="widget-main no-padding">
          ...
          <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('master_data/C_jenis_tindakan/process')?>" enctype="multipart/form-data">
              <br>
              <!-- hidden form -->
              <div class="form-group">
                <label class="control-label col-md-2">ID</label>
                <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->kode_jenis_tindakan:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                </div>
              </div>

              <div class="form-group">
                <label class="control-label col-md-2">Nama Jenis Tindakan</label>
                <div class="col-md-4">
                    <input name="jenis_tindakan" id="jenis_tindakan" value="<?php echo isset($value)?$value->jenis_tindakan:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                </div>
              </div>
              ...
              <div class="form-actions center">
                <a onclick="getMenu('master_data/C_jenis_tindakan')" href="#" class="btn btn-sm btn-success">
          ...
          $.ajax({
            ...
            complete: function(xhr) {     
              ...
              if(jsonResponse.status === 200){
                ...
                $('#page-area-content').load('master_data/C_jenis_tindakan');
              }else{
                $.achtung({message: jsonResponse.message, timeout:5});
              }
              achtungHideLoader();
