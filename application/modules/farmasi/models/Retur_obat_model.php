...
class Retur_obat_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		if(isset($_GET['search_by']) AND $_GET['search_by'] != '' AND isset($_GET['keyword']) AND $_GET['keyword'] != '' ){
			...
			if( isset($_GET['no_mr']) AND $_GET['no_mr'] != 0 ){
				$this->db->where('DATEDIFF(Day, tgl_trans, getdate()) <= 60');
			}else{
	...
	public function get_detail_resep_data($kode_trans_far){
		...
		a.jumlah_tebus, a.jumlah_pesan, c.satuan_kecil, b.urgensi, b.dosis_obat, b.dosis_per_hari, b.aturan_pakai, b.anjuran_pakai, b.catatan_lainnya, b.status_tebus, a.tgl_input, b.status_input, b.prb_ditangguhkan, b.jumlah_obat_23, b.satuan_obat, a.jumlah_retur, tgl_retur, d.no_registrasi, d.no_mr, d.nama_pasien, d.kode_bagian_asal, d.kode_bagian, d.kode_profit, no_kunjungan, d.flag_trans, a.resep_ditangguhkan, a.harga_beli');
