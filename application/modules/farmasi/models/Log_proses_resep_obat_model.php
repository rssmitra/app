...
class Log_proses_resep_obat_model extends CI_Model {
	...
	var $select = 'fr_tc_far.no_registrasi, fr_tc_far.kode_trans_far,fr_tc_far.nama_pasien,dokter_pengirim,no_resep,fr_tc_far.no_kunjungan,fr_tc_far.no_mr, fr_tc_far.kode_pesan_resep, tgl_trans, nama_pelayanan, alamat_pasien, telpon_pasien, fr_tc_far.status_transaksi, fr_tc_far.jenis_resep, status_terima, flag_trans, tgl_pesan, log_time_1, log_time_2, log_time_3, log_time_4, log_time_5, log_time_6, fr_tc_pesan_resep.status_batal, status_tebus, status_ambil_obat, nama_bagian, fr_tc_pesan_resep.kode_bagian_asal, fr_tc_pesan_resep.kode_perusahaan, jen_kelamin';
	...
	private function _get_datatables_query()
	{
		...
		if(isset($_GET['flag']) AND $_GET['flag'] != ''){
			if($_GET['flag'] == 'resep_diterima'){
				...
				$this->db->where('(log_time_2 is not null AND log_time_3 is null AND log_time_4 is null AND log_time_5 is null)');
