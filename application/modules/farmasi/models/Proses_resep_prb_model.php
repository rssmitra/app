...
class Proses_resep_prb_model extends CI_Model {
	...
	public function get_detail($kode_trans_far)
	{
		...
		prb_ditangguhkan,fr_tc_far_detail_log_prb.jumlah, fr_tc_far_detail_log_prb.kd_tr_resep, fr_tc_far_detail_log_prb.id_fr_tc_far_detail_log_prb, fr_tc_log_mutasi_obat.jumlah_mutasi_obat, resep_ditangguhkan")->get_where('fr_tc_far_detail_log_prb', array('fr_tc_far_detail_log_prb.kode_trans_far' => $kode_trans_far))->result();		
	}
