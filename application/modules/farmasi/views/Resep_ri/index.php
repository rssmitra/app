...
$(document).ready(function(){
  ...
  oTable = $('#dynamic-table').DataTable({ 
    ...
    /*"ajax": {
     ...
     "ajax": {
        "url": "farmasi/Resep_ri/get_data?search_by="+$("#search_by").val()+"&keyword="+$("#keyword_form").val()+"&is_icu="+$("#is_icu").val()+"",
        "type": "POST"
    },
    "columnDefs": [
        { 
  ...
  $('#dynamic-table tbody').on('click', 'td.details-control', function () {
      ...
      $('#btn_search_data').click(function (e) {
          e.preventDefault();
          $.ajax({
          url: 'farmasi/Resep_ri/find_data',
          type: "post",
          ...
          success: function(data) {
            achtungHideLoader();
            find_data_reload(data,'farmasi/Resep_ri');
          }
        });
      });
...
function find_data_reload(result=''){
  ...
  oTable.ajax.url('farmasi/Resep_ri/get_data?'+result.data).load();
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="farmasi/Resep_ri/find_data">
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="farmasi/Resep_ri" class="table table-bordered table-hover">
        <thead>
          <tr>  
            <th width="50px">&nbsp;</th>
            <th width="50px">&nbsp;</th>
