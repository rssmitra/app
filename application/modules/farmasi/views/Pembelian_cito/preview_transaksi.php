<div class="row">
  ...
  <div class="col-xs-12">
    ...
    <button onclick="PopupCenter('farmasi/Pembelian_cito/nota_pembelian?induk=<?php echo $value[0]->induk_cito?>')" class="btn btn-xs btn-success" title="Print">
        <i class="fa fa-print dark"></i> Print Nota Pembelian
    </button>
