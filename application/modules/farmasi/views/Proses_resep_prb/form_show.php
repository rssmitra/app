  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_proses_resep" enctype="multipart/form-data" autocomplete="off" action="farmasi/Proses_resep_prb/process">      
      ...
      <div class="row">
          ...
          <div class="col-sm-6">
            <h4>
            <a href="#" onclick="PopupCenter('farmasi/Verifikasi_resep_prb/nota_farmasi/<?php echo $value->kode_trans_far?>?flag=<?php echo $flag?>')" title="Nota Farmasi">
                <i class="fa fa-print dark"></i>
            </a>
            <?php echo isset($value)?ucwords($value->kode_trans_far):''?> - (<?php echo isset($value)?ucwords($value->no_resep):''?>) </h4>
          </div>
