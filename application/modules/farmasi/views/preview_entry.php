  ...
  <div class="col-xs-12">
    ...
    <div class="col-xs-6">
        <center>
          ...
          <div class="pull-right">
            <button onclick="PopupCenter('farmasi/Process_entry_resep/nota_farmasi/<?php echo $resep[0]['kode_trans_far']?>?tipe=resep_kronis')" class="btn btn-xs btn-warning" title="Nota Farmasi">
                <i class="fa fa-print dark"></i> Nota Farmasi
            </button>
          </div>
        </center>
