...
<form class="form-horizontal" method="post" id="form_search" action="templates/References/find_data" autocomplete="off">
  ...
  <table id="dynamic-table" base-url="farmasi/History_resep_prb/get_data" data-id="flag=All" url-detail="farmasi/History_resep_prb/get_detail" class="table table-bordered table-hover">
