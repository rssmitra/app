              ...
              foreach($resep as $row) { $no++;
                ...
                if($row['flag_resep'] == 'biasa') :
                  ...
                  echo '<td>'.$nama_obat.'</td>';
                    ...
                    // harga satuan
                    echo '<td align="center">';
                    echo '<input style="width:100px;height:25px;text-align:right" type="text" class="format_number" name="harga_jual_satuan_'.$row['kode_brg'].'" value="'.$row['harga_jual_satuan'].'" '.$readonly.'>';
                  ...
                  foreach ($row['racikan'][0] as $key => $value) {
                    ...
                    echo '<td align="center">';
                      ...
                      // harga satuan
                    echo '<td align="center">';
                    echo '<input class="format_number" style="width:100px;height:25px;text-align:right" type="text" name="harga_jual_satuan_'.$value->kode_brg.'" value="'.$value->harga_jual.'" '.$readonly.'>';
