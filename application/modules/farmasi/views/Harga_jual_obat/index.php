  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="pelayanan/Pl_pelayanan_ri/find_data">
        ...
        <div style="margin-top:-27px">
          ...
          <table id="dynamic-table" base-url="farmasi/Harga_jual_obat" data-id="flag=<?php echo $flag_string?>" url-detail="farmasi/Harga_jual_obat/show_detail" class="table table-bordered table-hover">
            <thead>
              <tr>  
