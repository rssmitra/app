...
class Csm_costing_casemix extends MX_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        /*breadcrumb default*/
        $this->breadcrumbs->push('Index', 'casemix/Csm_costing_casemix');
    ...
    public function index() { 
        ...
        /*load view index*/
        $this->load->view('Csm_costing_casemix/index', $data);
    }

    public function run_scheduler(){

        // Menentukan skrip CLI yang ingin dijalankan
        $cliScript = 'scheduler/Auto_merge_dok_klaim_casemix/index '.$_POST['date'].'';
