...
<body style="background-color:white">
  ...
  <tr>
    <td>Nama Peserta</td><td>: <?php echo isset($sep->nama)?$sep->nama:$header->nama_pasien?></td>
    <td style="padding-left:200px">Jns. Rawat</td><td>: <?php echo isset($sep->jnsPelayanan) ? $sep->jnsPelayanan: 'R.Jalan'?></td>
  </tr>
  <tr>
    <td>Tgl Lahir</td><td>: <?php echo isset($sep->tglLahir)?$sep->tglLahir:$this->tanggal->formatDateDmy($header->tgl_lhr)?> &nbsp;&nbsp;&nbsp;&nbsp; Kelamin : <?php echo isset($sep->kelamin)?$sep->kelamin:$header->jen_kelamin?></td><td style="padding-left:200px">Kls. Rawat</td><td>: <?php echo isset($sep->kelasRawat)?$sep->kelasRawat:'Kelas 3'?></td>
  </tr>
  <tr>
