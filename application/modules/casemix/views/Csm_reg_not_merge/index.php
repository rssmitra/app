  ...
  <div class="col-xs-12">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        <label class="control-label col-md-2">Pencarian Data</label>
          <div class="col-md-10">
            <div class="radio">
              <label>
                <input name="search_data" type="radio" class="ace" value="dokumen_klaim" >
                <span class="lbl"> Dokumen Klaim </span>
              </label>

              <label>
                <input name="search_data" type="radio" class="ace" value="reg_not_merge" checked>
      ...
      <div class="form-group" id="tanggal_field">
        <label class="control-label col-md-2" id="text_label">Tanggal Transaksi</label>
          <div class="col-md-2">
      ...
      <div class="form-group">
        <label class="control-label col-md-2">Tipe (RI/RJ)</label>
          ...
          <a href="#" id="button_submit_multiple" class="btn btn-xs btn-primary">
    ...
    <div style="margin-top:-27px">
      ...
      <script src="<?php echo base_url().'assets/js/custom/casemix/Csm_reg_not_merge.js'?>"></script>
