...
$(document).ready(function(){
    ...
    $('#btn_proses_dokumen').click(function (e) {
        e.preventDefault();
        $.ajax({
          url: 'casemix/Csm_costing_casemix/run_scheduler',
          type: "post",
          data: $('#form_csm_costing_casemix').serialize(),
          dataType: "json",
          beforeSend: function() {
    ...
    <!-- PAGE CONTENT BEGINS -->
      <div class="widget-body">
        <div class="widget-main no-padding">
          <form class="form-horizontal" method="post" id="form_csm_costing_casemix" action="<?php echo site_url('casemix/Csm_costing_casemix/run_scheduler')?>" enctype="multipart/form-data">
            <br>
