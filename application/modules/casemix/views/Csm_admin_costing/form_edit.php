            ...
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_Csm_billing_pasien" action="<?php echo site_url('casemix/Csm_billing_pasien/process')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <div class="col-md-7">
                     ...
                     <tr>
                         <th width="30px" class="center">Kode</th>
                         <th>Uraian</th>
                      ...
                      foreach ($group as $k => $val) { ?>
                         <tr>
                         <td width="30px" class="center"><i class="fa fa-circle"></i></td>
                         ...
                         <td width="100px" align="center"></td>
                          ...
                          foreach ($val as $value_data) { ?>
                             <tr>
                             <td width="30px">
                                <input type="hidden" name="kode_trans_pelayanan[<?php echo $value_data->csm_bp_id?>]" class="form-control" value="<?php echo $value_data->csm_bp_kode_trans_pelayanan?>" readonly>
                                <?php echo $value_data->csm_bp_kode_trans_pelayanan?>
                              </td>
                             <td width="200px">
                                <input type="hidden" name="nama_tindakan[<?php echo $value_data->csm_bp_id?>]" class="form-control" id="nama_tindakan_<?php echo $value_data->csm_bp_id?>" style="width:100%" value="<?php echo $value_data->csm_bp_nama_tindakan?>" readonly>
                                <?php echo $value_data->csm_bp_nama_tindakan?>
                              </td>
                             <td width="100px" align="right">

                              <input type="text" name="subtotal_tindakan_per_item[<?php echo $value_data->csm_bp_id?>]" class="subtotal_tindakan jenis_tindakan_<?php echo $value_data->csm_bp_jenis_tindakan?>" id="subtotal_tindakan_<?php echo $value_data->csm_bp_id?>" style="width:100%;text-align:right" value="<?php echo $value_data->csm_bp_subtotal?>" onKeyUp="executeChange(<?php echo $value_data->csm_bp_id?>)">
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('casemix/Csm_admin_costing')" href="#" class="btn btn-sm btn-success">
