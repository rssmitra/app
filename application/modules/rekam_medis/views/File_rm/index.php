...
<div id="accordion" class="accordion-style1 panel-group">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-collapse collapse <?php echo ($key_emr==0)?'in':'collapsed'?>" id="collapse<?php echo $key_emr?>">
            ...
            <iframe src="<?php echo BASE_FILE_RM.'uploaded/rekam_medis/'.$row_emr->no_mr.'/'.$row_emr->filename.'.pdf'?>" frameborder="0" width="100%" style="height: 900px !important; padding: 20px !important"></iframe>
            </div>
        </div>
    </div>
    <?php endforeach; else: ?>
