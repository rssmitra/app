...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="templates/References/find_data">
          ...
          <div class="form-group">
            ...
            <div class="col-md-2">
              <select class="form-control" name="flag" id="flag">
                ...
                <option value="RJ" selected>[RJ] Rawat Jalan</option>
                <option value="RI">[RI] Rawat Inap</option>
                <option value="PB">[PB] Pembelian Bebas Apotik</option>
              </select>
            </div>
        ...
        <div class="col-md-12">
          <table id="dt_harian_kasir" base-url="eksekutif/Eks_profit_by_close_bill/get_data" class="table table-bordered table-hover">
            <thead>
