...
<script type="text/javascript">
  ...
  function show_detail(flag){
    preventDefault();
    $('#show_detail_by_click').load('eksekutif/Eks_hutang_usaha/show_detail?flag='+flag+'&from_tgl='+$('#from_tgl').val()+'&to_tgl='+$('#to_tgl').val()+'');
  }
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="eksekutif/Eks_hutang_usaha/find_data">
      <!-- hidden form -->
      <div class="row">
          <div class="col-xs-10">
            <span style="font-size: 16px; font-weight: bold">DASHBOARD EKSEKUTIF</span><br>
            Laporan Keuangan Hutang Usaha
