  ...
  <table class="table table-bordered">
    ...
    <table class="table table-bordered" border="1">
      <tr>
        ...
        <th rowspan="3" style="vertical-align: middle">Nama Dokter/Poli/Klinik</th>
    ...
    <tbody>
      <?php 
        ...
        $arr_jp = [];
        $arr_rp = [];
        $no=0; foreach($value as $key=>$row_dt) : 
        if(!empty($key)) :
          $no++; 
      ?>
        <tr>
          <td align="center"><?php echo $no?></td>
          <td colspan="36"><?php echo $key; ?></td>
        </tr>
          ...
          <tr>
            ...
            <td class="center"><?php echo $total_last_month?></td>
            <td><?php echo $total_rp_last_month?></td>
            <td class="center">
                <?php 
        ...
        <tr>
          ...
          <td><?php echo array_sum($arr_total_last_month)?></td>
          <td><?php echo array_sum($arr_total_rp_last_month)?></td>
          <td class="center">
              <?php 
