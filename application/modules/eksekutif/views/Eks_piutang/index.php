...
<script type="text/javascript">
  ...
  $('#btn_search_data').click(function (e) {
      e.preventDefault();
      $.getJSON('eksekutif/Eks_piutang/get_content_page', {mod: 'poli', from_tgl: $('#from_tgl').val(), to_tgl : $('#to_tgl').val() }, function(response_data) {
        html = '';
  ...
  function show_detail(flag){
    preventDefault();
    $('#show_detail_by_click').load('eksekutif/Eks_piutang/show_detail?flag='+flag+'&from_tgl='+$('#from_tgl').val()+'&to_tgl='+$('#to_tgl').val()+'');
  }
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="eksekutif/Eks_piutang/find_data">
      <!-- hidden form -->
      <div class="row">
          <div class="col-xs-10">
            <span style="font-size: 16px; font-weight: bold">DASHBOARD EKSEKUTIF</span><br>
            Laporan Keuangan Piutang Perusahaan Asuransi
