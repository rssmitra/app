...
<script type="text/javascript">
  ...
  $('#btn_search_data').click(function (e) {
      ...
      $.getJSON('eksekutif/Eks_pendaftaran/get_content_page', $('#form_search').serialize(), function(response_data) {
        html = '';
  ...
  function show_detail(flag){
    preventDefault();
    $('#show_detail_by_click').load('eksekutif/Eks_pendaftaran/show_detail?flag='+flag+'&'+$('#form_search').serialize()+'');
  }

  function show_detail_unit(kode, flag){
    preventDefault();
    $('#show_detail_level_1').load('eksekutif/Eks_pendaftaran/show_detail_unit?kode='+kode+'&flag='+flag+'&'+$('#form_search').serialize()+'');
  }
  function show_detail_pasien(kode, flag){
    preventDefault();
    $('#show_detail_level_2').load('eksekutif/Eks_pendaftaran/show_detail_pasien?kode='+kode+'&flag='+flag+'&'+$('#form_search').serialize()+'');
  }
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="eksekutif/Eks_pendaftaran/find_data">
      <!-- hidden form -->
          ...
          <div class="col-xs-10">
            ...
            <div class="col-md-12 no-padding">
              ...
              <label>
                ...
                <span class="lbl"> Rekap Pendaftaran Pasien per Periode dan Harian, Bulanan dan Tahun Berjalan</span>
              </label>
              <br>
              <label>
                <input name="graph-line-1" type="checkbox" onclick="checked_checkbox(this.name)" class="ace" value="1">
                <span class="lbl"> Grafik Line Pendaftaran Pasien per Tahun</span>
              </label>
              ...
              <label>
                ...
                <span class="lbl"> Rekapitulasi Pendaftaran Detail Harian Berdasarkan Unit/Bagian per Bulan</span>
              </label>
              ...
              <label>
                ...
                <span class="lbl"> Rekapitulasi Pendaftaran Berdasarkan Nama Pasien per Periode</span>
              </label>
