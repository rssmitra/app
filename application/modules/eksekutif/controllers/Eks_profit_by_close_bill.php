...
class Eks_profit_by_close_bill extends MX_Controller {
    ...
    public function get_data()
    {
        ...
        $html = $this->load->view('eksekutif/Eks_profit_by_close_bill/index_2', $respons, true);
        ...
        $html_costing = $this->load->view('eksekutif/Eks_profit_by_close_bill/index_3', $respons_costing, true);

        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => count($getList),
                        "recordsFiltered" => $this->Eks_profit_by_close_bill->count_filtered(),
                        "data" => $data,
    ...
    public function getDetailTransaksi($kode_tc_trans_kasir, $no_registrasi, $jenis_tindakan=''){
        ...
        $akunting = $this->Eks_profit_by_close_bill->get_jurnal_akunting($kode_tc_trans_kasir);
        ...
        $html = $this->load->view('eksekutif/Eks_profit_by_close_bill/detail_transaksi_view', $data, true);
        echo json_encode(array('html' => $html));
    }

    public function export_excel(){
        $list = $this->Eks_profit_by_close_bill->get_data()->result(); 
        // echo '<pre>';print_r($list);die;
        $getList = [];
        $getListCosting = [];
        $getListJenisTindakan = [];
        ...
        if($_GET['type'] == 1){
            ...
            $this->load->view('eksekutif/Eks_profit_by_close_bill/excel_view', $data);
        }
        ...
        if($_GET['type'] == 2){
            ...
            $this->load->view('eksekutif/Eks_profit_by_close_bill/excel_view_2', $data);
        }
        ...
        if($_GET['type'] == 3){
            ...
            $this->load->view('eksekutif/Eks_profit_by_close_bill/excel_view_3', $respons_costing);
        }
