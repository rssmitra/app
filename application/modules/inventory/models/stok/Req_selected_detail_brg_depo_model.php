...
class Req_selected_detail_brg_depo_model extends CI_Model {
	...
	private function _main_query(){
		...
		if( $_GET['flag'] == 'medis' ){
			$this->db->select('depo.kode_depo_stok');
			$this->db->join('(SELECT * FROM mt_depo_stok_v WHERE kode_bagian = '."'".$_GET['kode_bagian']."'".') as depo','depo.kode_brg=a.kode_brg','left');	
			$this->db->group_by('kode_depo_stok');
		}
