...
class Create_agenda_so_model extends CI_Model {
	...
	{
		/*delete stok opname*/
		$this->db->where_in('agenda_so_id', $id)->delete('tc_stok_opname');
		$this->db->where_in('agenda_so_id', $id)->delete('tc_stok_opname_nm');
		$this->db->where_in('agenda_so_id', $id)->delete('tc_stok_opname_agenda');
		return true;
	}
