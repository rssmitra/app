...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_input_dt_so_header" action="<?php echo site_url('inventory/so/Input_dt_so/process')?>" enctype="multipart/form-data" autocomplete="off">
      <br>
      ...
      <div class="form-group">
        <label class="control-label col-md-2">Bagian Unit</label>
          <div class="col-md-4">
            ...
            <?php echo $this->master->custom_selection($params = array('table' => 'mt_bagian', 'id' => 'kode_bagian', 'name' => 'nama_bagian', 'where' => array('depo_group !=' => NULL) ), '' , 'bagian', 'bagian', 'form-control', '', '') ?>
          </div>
      </div>
