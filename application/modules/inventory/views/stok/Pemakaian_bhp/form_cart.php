  ...
  $('#form_cart').ajaxForm({
    ...
    complete: function(xhr) {     
      ...
      if(jsonResponse.status === 200){
        ...
        $('#form_div').hide();
        $('#div_table').show();
        $('#page-area-content').load('inventory/stok/Pemakaian_bhp/index?flag='+$("input[name='flag_gudang']:checked"). val()+'');
...
<form class="form-horizontal" method="post" id="form_cart" action="inventory/stok/Pemakaian_bhp/process_pemakaian_bhp" enctype="multipart/form-data" style="margin-top: -10px">
  ...
  <!-- hidden form -->
    ...
    <div class="form-group">
      <label class="control-label col-md-3">Tanggal Pemakaian</label>
      <div class="col-md-4">
        <div class="input-group">
          <input class="form-control date-picker" name="tgl_pemakaian_bhp" id="tgl_pemakaian_bhp" type="text" data-date-format="yyyy-mm-dd" value="<?php echo date('Y-m-d')?>"/>
    ...
    <div class="form-group" id="catatan_form">
    ...
    <table class="table table-bordered">
      <thead>
          <tr style="background-color: #e4e7e8;color: #0a0a0a;font-weight: bold; border: 1px solid #ababab; border-collapse: collapse">
            ...
            <th rowspan="2" style="text-align:center; width: 10%; border: 1px solid #ababab; border-collapse: collapse">Unit/Bagian</th>
      ...
      <tbody>
          <?php 
            ...
            foreach($cart_data as $row_cart){
              ...
              echo '<td style="text-align:center; border-left: 1px solid #ababab; border-collapse: collapse">'.$row_cart->nama_bagian.'</td>';
          ...
          ?>
          <tr>
            <td colspan="5" style="text-align:right; padding-right: 20px; border: 1px solid #ababab; border-collapse: collapse">Total </td>
            <td style="text-align:right; border: 1px solid #ababab; border-collapse: collapse"><?php echo number_format(array_sum($arr_total))?></td>
          </tr>
          <tr>
            <td colspan="5" style="text-align:right; border-bottom: 1px solid #ababab; border-collapse: collapse">Terbilang : 
