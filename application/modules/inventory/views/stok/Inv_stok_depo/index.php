  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="inventory/stok/Inv_stok_depo/find_data" autocomplete="off">
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <?php 
              echo $this->master->get_depo_aktif($params = array('table' => 'mt_bagian', 'id' => 'kode_bagian', 'name' => 'nama_bagian', 'where' => array('is_depo' => 'Y')), '060101' , 'kode_bagian', 'kode_bagian', 'form-control', '', '') ?>
          </div>
