    ...
    $('#form_info_jadwal_dr').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('information/Regon_info_jadwal_dr_eksekutif?_=' + (new Date()).getTime());
        }else{
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_info_jadwal_dr" action="<?php echo site_url('information/Regon_info_jadwal_dr_eksekutif/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('information/Regon_info_jadwal_dr_eksekutif')" href="#" class="btn btn-sm btn-success">
