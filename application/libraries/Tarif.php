    ...
    public function insert_tarif_by_jenis_tindakan($data, $jenis_tindakan){
        ...
        if($data['kode_perusahaan']==120){
            ...
            if($jenis_tindakan == 12){
                ...
                $where_str = 'and kode_tarif=120003';
            }else{
                $where_str = 'and kode_tarif=6251395';
            }
