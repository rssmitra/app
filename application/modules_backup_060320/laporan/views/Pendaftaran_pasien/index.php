    ...
    $('#btn_export_detail').click(function (e) {
      ...
      $.ajax({
        ...
        success: function(data) {
          achtungHideLoader();
          console.log(data)
          $(window).load("laporan/Pendaftaran_pasien/export_detail_view",data);
        }
      });
...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form_search" action="laporan/Pendaftaran_pasien/export_detail" target="blank">

    <div class="col-md-12">

    <center><h4>FORM PENCARIAN DATA PENDAFTARAN PASIEN<br><small style="font-size:12px">Data yang ditampilkan saat ini adalah data per Hari ini yaitu tanggal <?php echo date('d/m/Y')?> </small></h4></center>
      <br>
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="laporan/Pendaftaran_pasien" class="table table-bordered table-hover">
       <thead>
        <tr>  
