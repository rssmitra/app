...
<body>
  <div class="row">
    <div class="col-xs-12">
      ...
      <b>Nama Bagian :</b> <b><i><?php echo $r_data->nama_bagian;?></i></b>
      <br>
      <br>
      <table class="table">
        <thead>
          <tr>
            ...
            <th width="100">Tanggal Pengiriman</th>
           <th width="120">Kode Barang</th>
            <th width="176">Nama Barang</th>
            <th width="100" align="center">Jumlah Permintaan</th>
        ...
        <tbody>
          ...
          foreach($result['data'] as $row_data){
            $jmlp         = $row_data->jumlah_permintaan;
            ...
            <tr>
              ...
              <?php 
                  echo '<td>'.$row_data->tgl_permintaan.'</td>';
                  echo '<td>'.$row_data->tgl_pengiriman.'</td>';
                  echo '<td>'.$row_data->kode_brg.' </td>';
                  echo '<td>'.$row_data->nama_brg.' </td>';
                  echo '<td>'.$row_data->jumlah_permintaan.'</td>';
