...
<div class="row">
    ...
    <div id="data_vk">
      ...
      <div class="col-sm-12">
          ...
          <p><b><i class="fa fa-edit"></i> PESAN VK </b></p>

          <div class="form-group">
              <label class="control-label col-sm-2" for="">*Kamar</label>
              <div class="col-sm-4">
    ...
    <div id="data_ok" style="display:none">
      ...
      <div class="col-sm-12">
          ...
          <p><b><i class="fa fa-edit"></i> PESAN OK </b></p>
    ...
    <div id="data_pesan_pindah" style="display:none">
      ...
      <p><b><i class="fa fa-edit"></i> PESAN PINDAH </b></p>

      <div class="form-group">
        
          <div class="col-sm-4" style="margin-left:6px">
            <a href="#" class="btn btn-m btn-primary" id="btn_add_pindah"> Pesan </a>
          </div>
      </div>
