    ...
    <div class="col-xs-8">
        <table style="font-size:12px" border="0">
			...
			<tr>
				...
				<td width="67%" bgcolor="#EBEBEB" nowrap style="font-size:12px">: <b>Rp. <?php echo number_format($total_payment)?></b></td> 
			</tr>
			<tr>
				<td width="20%" valign="top" style="font-size:12px">Terbilang </td> 
				<td style="67%" bgcolor="#EBEBEB" nowrap style="font-size:12px">: 
				<b>
					<i>"<?php $terbilang = new Kuitansi(); echo ucwords($terbilang->terbilang($total_payment))?> Rupiah"</i></b>
				</td>
			</tr> 
			<tr>
				<td width="20%">&nbsp;</td> 
