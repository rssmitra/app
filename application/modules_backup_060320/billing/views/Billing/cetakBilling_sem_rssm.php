...
<div class="body_print">
  ...
  <div class="col-xs-12">
      ...
      <div class="timeline-container timeline-style2">
          <span class="timeline-label" style="width:95px !important">
                  ...
                  <div class="widget-box transparent">
                      <div class="widget-body">
                          <div class="widget-main no-padding">
                              ...
                              <?php 
                                  $sum_array[$key_s][] = $subtotal;
                                  endforeach; 
                                  $arr_sum_total[] = array_sum($sum_array[$key_s]);
                              ?>
                              <tr style="font-weight: bold; font-size: 13px">
                                  <td align="right">Total</td>
                                  <td style="text-align: right"><?php echo number_format(array_sum($sum_array[$key_s]))?></td>
                              </tr>
        ...
        <table border="0" width="100%">
          <tr>
            <td style="text-align: right">
              ...
              <div class="col-xs-4">
              <span style="margin-left:-80%;position:fixed; margin-top: -15%; font-size: 24px" class="stamp center">BILLING<br>SEMENTARA</span>
              </div>
              <?php endif;?>
