...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group">
        <label class="control-label col-md-2">Transaksi Tanggal</label>
          <div class="col-md-2">
...
<script src="<?php echo base_url().'assets/js/custom/casemix/Csm_admin_costing.js'?>"></script>
