    ...
    <!-- PAGE CONTENT BEGINS -->
      ...
      <thead>
        <tr style="background-color: #e4e7e8;color: #0a0a0a;font-weight: bold; border: 1px solid #cecaca; border-collapse: collapse">
          ...
          <td rowspan="2" style="text-align:center; width: 60px; border: 1px solid #cecaca; border-collapse: collapse">Jumlah<br>Pesan</td>
          <td rowspan="2" style="text-align:center; width: 75px; border: 1px solid #cecaca; border-collapse: collapse">Harga Satuan</td>
        ...
        ?>
            <tr>
              ...
              <td style="text-align:center; border: 1px solid #cecaca; border-collapse: collapse"><?php echo array_sum($jumlah_pesan[$row_dt[0]->kode_brg])?></td>
