<body>
  <table width="100%" border="0">
    <tr>
      <td width="80px"><img src="<?php echo base_url().'assets/images/logo.png'?>" alt="" width="70px"></td>
      <td valign="bottom" width="500px"><b><span style="font-size: 18px">Rumah Sakit Setia Mitra</span></b><br>Jl. RS Fatmawati No.80-82, RT.3/RW.10, Cilandak Barat, Cilandak, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12430</td>
