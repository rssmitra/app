        ...
        <tbody>
          <?php 
            ...
            foreach($dt_detail_brg as $key_dt=>$row_dt) : 
              ...
              // if( array_sum($jumlah_kirim_arr[$key_dt]) < array_sum($jumlah_pesan_arr[$key_dt]) ) :
          ?>
          ...
          <tr id="tr_<?php echo $row_dt[0]->kode_brg?>" style="border: 1px #d8d5d5  solid">
            ...
            <td class="center" style="border: 1px #d8d5d5  solid">
              ...
              <!-- hidden -->
              <!-- <input type="hidden" name="id_tc_po[<?php echo $row_dt[0]->kode_brg?>]" id="id_tc_po" value="<?php echo $row_dt[0]->id_tc_po?>"> -->
            </td>
