    ...
    <!-- PAGE CONTENT BEGINS -->
      ...
      <thead>
        <tr style="background-color: #e4e7e8;color: #0a0a0a;font-weight: bold; border: 1px solid #cecaca; border-collapse: collapse">
          ...
          <td style="text-align:center; width: 50px; border: 1px solid #cecaca; border-collapse: collapse">Isi Kemasan</td>
        ...
        <?php 
          ...
          foreach($po_data as $key_dt=>$row_dt) : $no++; 
            $tr_color = ($row_dt->jumlah_besar_acc > $row_dt->jumlah_kirim) ? '<i class="fa fa-exclamation-triangle red"></i>' : '<i class="fa fa-check-circle green"></i>' ;
        ?>
            <tr>
              ...
              <td style="text-align:center; border: 1px solid #cecaca; border-collapse: collapse"><?php echo number_format($row_dt->jumlah_besar_acc, 2)?></td>
              <td style="text-align:center; border: 1px solid #cecaca; border-collapse: collapse"><?php echo ($row_dt->jumlah_kirim)? number_format($row_dt->jumlah_kirim, 2):0; ?> <?php echo $tr_color; ?> </td>
              <td style="text-align:right; border: 1px solid #cecaca; border-collapse: collapse"><?php echo number_format($row_dt->harga_satuan_netto, 2); ?></td>
              <td style="text-align:right; border: 1px solid #cecaca; border-collapse: collapse"><?php echo number_format($row_dt->total_harga_netto, 2); ?></td>
            </tr>
            <?php endforeach;?>
