...
function show_default_cart(){
  $('#div_cart').load('purchasing/pendistribusian/Pengiriman_unit/show_cart?flag='+$("input[name='flag_gudang']:checked"). val()+'');
}
...
function delete_cart(kode_brg){
  ...
  $.ajax({
    ...
    type: "post",
    data: {ID: kode_brg, flag: $('#flag_string').val()},
    dataType: "json",
    beforeSend: function() {
      achtungShowLoader();  
    },
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <div class="radio">
                              ...
                              <label>
                                <input name="flag_gudang" type="radio" class="ace" value="non_medis" checked/>
                    ...
                    <div class="widget-body" style="background: #edf3f4;">
                      <div class="widget-main">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3" >
                              <input class="form-control" type="number" name="kode_brg_hidden" id="qtyBarang">
                            </div>
                            <div class="col-md-1" style="margin-left: -10px">
                              <a href="#" onclick="" class="btn btn-xs btn-yellow"><i class="fa fa-shopping-cart"></i></a>
                            </div>
                          </div>
                      </div>
                    </div>
