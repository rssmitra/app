  ...
  $('#form_cart').ajaxForm({
    ...
    complete: function(xhr) {     
      ...
      if(jsonResponse.status === 200){
        ...
        $('#form_div').hide();
        $('#div_table').show();
        $('#page-area-content').load('purchasing/pendistribusian/Pengiriman_unit/form_distribusi');
...
<form class="form-horizontal" method="post" id="form_cart" action="<?php echo site_url('purchasing/pendistribusian/Pengiriman_unit/process_pengiriman_brg_unit')?>" enctype="multipart/form-data" style="margin-top: -10px">
  <div class="row" style="margin-top: -13px;">

  <!-- hidden form -->
    <input type="hidden" name="flag" id="flag_cart" value="<?php echo $flag?>">
    ...
    <div class="form-group">
      <label class="control-label col-md-3">Tujuan ke unit</label>
      <div class="col-md-7">
        <?php 
