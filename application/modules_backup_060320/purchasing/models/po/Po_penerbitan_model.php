...
class Po_penerbitan_model extends CI_Model {
	...
	public function rollback_po($flag, $id)
	{
		...
		$this->db->where('id_tc_permohonan', $id)->update($tc_permohonan.'_det', array('jumlah_besar_acc' => NULL, 'jml_besar_acc' => NULL, 'jml_acc_pemeriksa' => NULL, 'jml_acc_penyetuju' => NULL, 'status_po' => NULL) );
