...
function preventDefault(e) {
  ...
  $('select[name="klinik_rajal"]').change(function () {      
        ...
        if ($(this).val()) {          
            ...
            $.getJSON("<?php echo WS_URL.'Templates/References/getDokterBySpesialis' ?>/" + $(this).val(), '', function (data) {              
    ...
    $('select[name="dokter_rajal"]').change(function () {      
        ...
        if ($(this).val()) {          
            ...
            $.getJSON("<?php echo WS_URL.'Templates/References/getJadwalPraktek' ?>/" + $(this).val() + '/' + kode_spesialis, '', function (data) {              
    ...
    function detailJadwalPraktek(jd_id){
        preventDefault();
        $.getJSON("<?php echo WS_URL.'Templates/References/getDetailJadwalPraktek' ?>/" + jd_id, function (data) {
                /*here show data from jadwal praktek*/               
