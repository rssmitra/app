...
class Reg_pm_model extends CI_Model {
	...
	public function get_hasil_pm($no_registrasi, $no_kunjungan, $kode_bagian='', $flag_mcu='' ){
		...
		if($flag_mcu==1){
			...
			select kode_trans_pelayanan_paket_mcu from tc_trans_pelayanan_paket_mcu where no_kunjungan='.$no_kunjungan.') AND b.kode_bagian='."'".$kode_bagian."'".' AND a.hasil != '."''".' GROUP BY a.kode_trans_pelayanan,b.detail_item_1, b.nama_pemeriksaan, b.standar_hasil_wanita, b.standar_hasil_pria, b.satuan , a.keterangan, a.hasil
