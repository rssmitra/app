...
class Perjanjian_rj_model extends CI_Model {
	...
	var $select = 'tc_pesanan.id_tc_pesanan, tc_pesanan.nama, tc_pesanan.no_telp, tc_pesanan.no_hp, tc_pesanan.tgl_pesanan, tc_pesanan.no_mr, mt_bagian.nama_bagian, mt_karyawan.nama_pegawai, mt_perusahaan.nama_perusahaan, tc_pesanan.tgl_masuk, tc_pesanan.kode_dokter, tc_pesanan.no_poli, tc_pesanan.kode_perjanjian, tc_pesanan.unique_code_counter, tc_pesanan.selected_day';
	...
	private function _main_query(){
        ...
        if (isset($_GET['tanggal']) AND $_GET['tanggal'] != '' ) {
			...
			$curr_month = date('m');
			$this->db->where('MONTH(tgl_pesanan) >= '.$curr_month.'');	
