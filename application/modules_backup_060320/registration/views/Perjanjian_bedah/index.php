...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="col-md-12">
      ...
      <center><h4>FORM PENCARIAN DATA PERJANJIAN BEDAH<br><small style="font-size:12px">Data yang ditampilkan saat ini adalah Data perjanjian pasien bedah dari tanggal <b><?php echo $this->tanggal->formatDate(date('Y-m-d'))?> s/d tahun <?php echo date('Y')?></b> </small></h4></center>
      <br>
      ...
      <div class="form-group">
          ...
          <div class="col-md-4">
              ...
              <?php echo $this->master->custom_selection($params = array('table' => 'mt_bagian', 'id' => 'kode_bagian', 'name' => 'nama_bagian', 'where' => array('validasi' => '0300', 'kode_bagian' => '030901') ), '030901' , 'klinik', 'klinik', 'form-control', 'readonly', '') ?>
          ...
          <div class="col-md-4">
              <?php echo $this->master->custom_selection($params = array('table' => 'mt_dokter_v', 'id' => 'kode_dokter', 'name' => 'nama_pegawai', 'where' => array('kd_bagian' => '030901') ), '' , 'dokter', 'dokter', 'form-control', '', '') ?>
    ...
    <div style="margin-top:-27px">
      <table id="dynamic-table" base-url="registration/Perjanjian_bedah" class="table table-bordered table-hover">
       <thead>
        <tr>  
