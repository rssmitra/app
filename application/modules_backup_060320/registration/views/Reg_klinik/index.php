      ...
      complete: function(xhr) {             
        ...
        if(jsonResponse.status === 200){          
          ...
          if( $('select[name="jenis_pendaftaran"]').val() == 1){
            PopupCenter('registration/Reg_klinik/print_bukti_pendaftaran_pasien?nama='+jsonResponse.nama+'&no_mr='+jsonResponse.no_mr+'&no_reg='+jsonResponse.no_reg+'&poli='+jsonResponse.poli+'&dokter='+jsonResponse.dokter+'&nasabah='+jsonResponse.nasabah+'', 'FORM BUKTI PENDAFTARAN PASIEN', 950, 550);
          }
