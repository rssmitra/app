...
$(document).ready(function() {
  //initiate dataTables plugin
    oTable = $('#dynamic-table').DataTable({ 
      ...
      "ajax": {
          "url": "casemix/Csm_admin_costing/get_data",
          "type": "POST"
      },
      "columnDefs": [
        { 
...
function submit_multiple_action(myid){
  if(confirm('Are you sure?')){
    $.ajax({
        url: 'casemix/Csm_admin_costing/submit_multiple',
        type: "post",
        data: {ID:myid},
        dataType: "json",
        beforeSend: function() {
...
function searchAction(){
  $.ajax({
    url: 'casemix/Csm_admin_costing/find_data',
    type: "post",
...
function reset_table(){
    oTable.ajax.url('casemix/Csm_admin_costing/get_data').load();
...
function find_data_reload(result){
    ...
    oTable.ajax.url('casemix/Csm_admin_costing/get_data?num='+data.no_sep_mr+'&frmdt='+data.from_tgl_reg+'&todt='+data.to_tgl_reg+'&tipe='+data.tipe_ri_rj+'&search_by='+data.search_by+'').load();
    $("html, body").animate({ scrollTop: "400px" });
...
function submit(no_registrasi){
    ...
    $.ajax({
        url: 'casemix/Csm_admin_costing/process',
        type: "post",
...
function update_status_nk_kode_perusahaan(no_registrasi){
    ...
    preventDefault();
    $.ajax({
        url: 'casemix/Csm_admin_costing/update_status_nk_kode_perusahaan',
        type: "post",
...
function submit_kasir(no_registrasi){

    preventDefault();
    $.ajax({
        url: 'casemix/Csm_admin_costing/submit_kasir',
        type: "post",
        data: {no_registrasi:no_registrasi},
        dataType: "json",
        beforeSend: function() {
...
function rollback_kasir(no_reg){
    if(confirm('Are you sure?')){
        preventDefault();
        $.ajax({
          url: "casemix/Csm_billing_pasien/rollback_kasir",
          data: {no_reg : no_reg},            
          dataType: "json",
          type: "POST",
