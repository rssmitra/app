...
!function(e) {
    ...
    function _(e, t, r) {
        ...
        for (; e.length || t.length; ) {
            var d = s();
            if (n += C(r.substring(a, d[0].offset)),
            a = d[0].offset,
            d === e) {
    ...
    function R(t, e, n, r) {
        ...
        function s() {
            g += (null != f.sL ? function() {
                ...
                return 0 < f.relevance && (h += t.relevance),
                e && (m[f.sL] = t.top),
            ...
            : function() {
                ...
                r = f.lR.exec(_); r; )
                    ...
                    (e = n.k.hasOwnProperty(s) && n.k[s]) ? (h += e[1],
                    a += c(e[0], C(r[0]))) : a += C(r[0]),
                    t = f.lR.lastIndex,
                    r = f.lR.exec(_);
        ...
        function a(e, t) {
            ...
            if ("begin" == u.type && "end" == t.type && u.index == t.index && "" === r)
                return _ += i.slice(t.index, t.index + 1),
                1;
            if ("begin" === (u = t).type)
                return l(t);
            if ("illegal" === t.type && !n)
                throw new Error('Illegal lexeme "' + r + '" for mode "' + (f.cN || "<unnamed>") + '"');
            if ("end" === t.type) {
                var a = d(t);
                if (null != a)
                    return a
        ...
        B(b);
        var p, f = r || b, m = {}, g = "";
        for (p = f; p !== b; p = p.parent)
            p.cN && (g = c(p.cN, "", !0) + g);
        var _ = ""
          , h = 0;
        try {
            for (var v, y, N = 0; f.t.lastIndex = N,
            v = f.t.exec(i); )
                y = a(i.substring(N, v.index), v),
                N = v.index + y;
            for (a(i.substr(N)),
            p = f; p.parent; p = p.parent)
                p.cN && (g += k);
            return {
                relevance: h,
                value: g,
    ...
    function d(e) {
        var t, r, a, n, i, s, c, o, l, d, u = function(e) {
            ...
            r = p.exec(i)) {
                var s = A(r[1]);
                return s || (console.warn(E.replace("{}", r[1])),
